...
- De nombreux liens internes sont cassés, notamment vers `🧠 Memory/TOKEN MAP.md` et `📜 Erratum Correction Identite Societe.md`. Il est nécessaire d'exécuter `python3 .dev/app/fix_internal_links.py` pour corriger ces erreurs automatiquement.
