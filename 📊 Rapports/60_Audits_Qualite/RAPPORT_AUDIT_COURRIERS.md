...
### 03 — Courrier SAS (Mise en Demeure)
...
### 04 — Courrier Assureur (Action Directe)
- **YAML :** Complet.
- **Structure :** Complète.
...
### 22, 23, 24 — Gabarits d'Attestations
...
### 34 — EMAIL Maire / Police Municipale ERP
...
### 1. `**[Adresse à compléter]**` — 12 occurrences dans 12 fichiers
| Fichier | Ligne |
|---------|-------|
| 04 | 35 |
| 05 | 28 |
...
### 2. `**[Finance Provision Référé]**` — 2 occurrences
- 03 (l. 99) et 06 (l. 151)

### 3. Tokens date/LRAR non résolus dans 06 V2
- 5 tokens créés pour cette version de relance

### 4. Absence de `source`/`drive_id` pour 4 fichiers `statut: final`
- 29, 30, 31, 35

### 5. Incohérence de format `[Token]` vs `**[Token]**`
Observé dans : 12, 15, 20, 22, 25, 26, 27, 28, 30, 31, 33, 34 (plus de 12 fichiers)

### 6. Fautes dans YAML `personnes` — [fichier 32](../../%E2%9A%96%EF%B8%8F%20Actes/%F0%9F%94%91%20Token/%E2%9A%96%EF%B8%8F%20Actes%20proceduraux/%F0%9F%93%91%20Bordereau%20Unifie.md)
...
### 8. Adresse email réelle dans strate token — [fichier 34](../../%E2%9A%96%EF%B8%8F%20Actes/%F0%9F%94%91%20Token/%E2%9A%96%EF%B8%8F%20Actes%20proceduraux/%F0%9F%93%91%20Bordereau%20Unifie.md)
