...
L'agent précédent a supprimé, dans `⚖️ Actes/🔑 Token/✉️ Courriers/🔄 Relances/✉️ Courrier - Dirigeants SAS - Relance.md`, la mention « **pour régler le téléviseur** » en la qualifiant d'hallucination.

**C'était une ERREUR** : le fait est attesté par la version réelle du document (`⚖️ Actes/👤 Reel/✉️ Courriers/✉️ Courrier - Dirigeants SAS - Relance.md`, l.76) et par le Google Doc de synthèse (l.140) :
...
- `⚖️ Actes/👤 Reel/⚖️ Actes proceduraux/📜 Contentieux civil/Référé - Conclusions Provision.md` (l.48) et version Token équivalente
