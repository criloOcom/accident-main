...
<!-- Breadcrumb -->
*[🏠](../../README.md) › [📊 Rapports](../README.md) › 85_RESTANT_A_FAIRE_2026-07-15*
<hr>
<!-- /Breadcrumb -->
...
## 1. DATES ERRONÉES (M01 + M09) — 109 points
...
## 2. MONTANTS DINTILHAC (M02) — 197 points
...
## 3. FONDEMENTS JURIDIQUES / CITATIONS (M03) — 1242 points
...
## 4. JURITEXT INVALIDES (M04) — 444 points
...
## 5. DOUBLE STRATE TOKEN/REEL (M05) — 162 points — ✅ VÉRIFIÉ LE 15/07 (pas de fuite dans le TEXTE, noms dans liens/chemins)
...
## 6. CONTRE-EXPERTISE MÉDICALE (M06) — 2 actions
...
## 7. REDONDANCES / CONTRADICTIONS (M07) — 5 points
...
## 8. CONSISTANCE INTERNE DES ACTES (M08) — 28 points — ⚠️ PARTIEL (visa corrigé, citations à vérifier)
- **Vérif live + action du 15/07 (Vague 2) :**
  - ✅ **Visa corrigé en toute sûreté** (4 fichiers) : « Vu les articles L. 227-8 **et L. 225-251** du Code de commerce » → « Vu l'article L. 227-8 du Code de commerce ». Pour une **SAS** (Chapitre VII C. com.), le fondement de la responsabilité des dirigeants est **L.227-8**, pas L.225-251 (qui est le régime des SA). Zéro doublon, zéro lien cassé.
    - Fichiers : `⚖️ Assignation Refere Provision.md`, `🛡️ Constitution Partie Civile.md`, `🔍 Requete Article 145 CPC.md`, `✉️🔄 SAS Dirigeants.md`.
  - ⏸️ **Citations narrative/corps LAISSÉES + FLAGGÉES « À VÉRIFIER »** (5 fichiers, 14 occurrences) : `⚖️ Assignation Refere Provision.md` (corps), `🛡️ Constitution Partie Civile.md` (corps), `✉️📜 SAS President.md` (corps), `🎤 Plaidoirie Responsabilite Dirigeants.md`, `🗄️ Archives/🧠 STRATEGIE Contentieux Penal.md`.
...
## 9. PROCESS / RÈGLES (M10) — 49 points
...
## 10. TIMELINE / PROCÉDURE (M11) — 7 points
...
## 11. FORMAT / CONVENTIONS (M12) — 520 points
...
## 12. TYPOS / ORTHOGRAPHE (M13) — 22 points (MAJEUR)
...
## 13. MÉMOIRES / CONCLUSIONS (M14) — 8 points
...
## 14. HYPOTHÈSES / SCÉNARIOS DÉFENSE (M15) — 7 points
