...
**Périmètre** : tous les `.md` hors `.git/`, `.pytest_cache/`, `.venv/`, `node_modules/`, `.opencode/`, et hors [📊 Rapports/🗄️ Archives](📊 Rapports/🗄️ Archives/README.md)
...
- 🟡 **~1095 références à des fichiers `.md` en texte brut** (non liées) détectées hors des balises markdown. Répartition : `README.md` (67), fichiers mémoire/rapports/actes token. Exemples :
  ...
  - [⚖️ Actes/🔑 Token/README.md](⚖️ Actes/🔑 Token/README.md) L22 : `MAP.md`, `VARIABLES.md` en texte brut.
...
- 🔴 **~15 `README.md` de sous-dossiers sans AUCUN frontmatter** (après breadcrumb, le fichier démarre par `# Titre`). Exemples confirmés :
  - [⚖️ Actes/Preuves officielles/20260529 🩹 DrJARDON/README.md](⚖️ Actes/Preuves officielles/20260529 🩹 DrJARDON/README.md)
  - [⚖️ Actes/Preuves officielles/20260708 ✉️ LR Relance ASSURANCE/README.md](⚖️ Actes/Preuves officielles/20260708 ✉️ LR Relance ASSURANCE/README.md)
  - [⚖️ Actes/🔑 Token/🗄️ Archives/annexes/README.md](⚖️ Actes/🔑 Token/🗄️ Archives/annexes/README.md)
...
- 🔴 **`🔙` (retour) présent dans 20 README de sous-dossiers** (ex. [⚖️ Actes/Preuves officielles/20260529 🩹 DrJARDON/README.md](⚖️ Actes/Preuves officielles/20260529 🩹 DrJARDON/README.md) L7 : `🔙 [📁 Preuves officielles](../README.md)`). Pattern de navigation interdit non supprimé lors du nettoyage.
- 🔴 **1 « Retour à l'accueil »** : [📊 Rapports/RAPPORT_NAVIGATION_INTERACTIVE_20260711.md](📊 Rapports/RAPPORT_NAVIGATION_INTERACTIVE_20260711.md) L78 — pattern interdit.
...
- 🟡 **13 sous-dossiers de `Preuves officielles/` sans `README.md` parent** : [⚖️ Actes/Preuves officielles/README.md](⚖️ Actes/Preuves officielles/README.md) n'existe pas, or chaque sous-dossier `…/README.md` pointe vers `../README.md` (parent absent) → 13 liens cassés.
...
| [⚖️ Actes/README.md](⚖️ Actes/README.md) | 9 | Pointe vers `token/` et `reel/` (renommés `🔑 Token`/`👤 Reel`) |
| `STATUS.md`, `DESIGN.md`, `VACCIN.md`, `DECISIONS.md`, rapport doc | 12 | Divers |

**Vrais bugs de liens (indépendants des fichiers fantômes) :**
- 🔴 [⚖️ Actes/README.md](⚖️ Actes/README.md) L21-40 : `token/README.md`, `reel/README.md`, `token/0X_…/README.md` → dossiers renommés `🔑 Token`/`👤 Reel` non propagés.
- 🔴 `13 📜 Responsabilites legales.md` L92-98 et `14 Stratégie jurisprudentielle.md` : `../../../📜 Lois/89-18.422_CourCassation.md` → le fichier réel est [📜 Lois/📜 Jurisprudence/89-18.422_CourCassation.md](📜 Lois/📜 Jurisprudence/89-18.422_CourCassation.md) (sous-dossier omis).
- 🔴 `01 ⚖️ Assignation.md` L106-126, 347-349 : `ANNEXE_1_Decision_CC_CIV1_1965-04-30.md` / `📎 Annexes/ANNEXE_…md` → les annexes sont dans [⚖️ Actes/📎 Annexes](⚖️ Actes/📎 Annexes/README.md) (chemin relatif faux).
...
- ⚪ **1 fichier quasi-vide** : [⚖️ Actes/👤 Reel/📂 Preuves officielles/README.md](⚖️ Actes/👤 Reel/📂 Preuves officielles/README.md) (3 lignes de contenu). À compléter ou supprimer.
...
2. Corriger [⚖️ Actes/README.md](⚖️ Actes/README.md) L21-40 : remplacer `token/`→`🔑 Token/`, `reel/`→`👤 Reel/` (9 liens).
...
**P2 — Structure**
11. Créer [⚖️ Actes/Preuves officielles/README.md](⚖️ Actes/Preuves officielles/README.md) (parent manquant pour 13 sous-dossiers).
...
16. Compléter ou supprimer [⚖️ Actes/👤 Reel/📂 Preuves officielles/README.md](⚖️ Actes/👤 Reel/📂 Preuves officielles/README.md) (3 lignes).
