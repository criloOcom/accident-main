...
> Objectif : en **10 minutes maximum**, présenter clairement l'affaire, l'urgence et ce que vous attendez de l'avocat AJ, puis repartir avec un plan d'action concret.

---

## I. TRAME ORALE — CE QUE VOUS DITES EN 10 MINUTES

### 1. Présentation ultra-courte (30 secondes)
...
### 2. Le problème juridique central (1 minute)

> « Pour moi, le problème est double :
> 1. **Responsabilité** : la vasque et l'installation étaient manifestement dangereuses (cassure préexistante, installation télé instable).
> 2. **Indemnisation** : la SAS a un **capital de 200 €**, je crains l'insolvabilité et, pour l'instant, **l'assureur RC n'est pas identifié**. »

À ajouter en une phrase :
- « Mon objectif réaliste est d'obtenir une **indemnisation complète** de mes préjudices, en passant par l'assurance si possible, et par les dirigeants / FGTI si nécessaire. »

### 3. Où en est la procédure (2–3 minutes)
...
> « Je ne vous demande pas de tout lire maintenant, mais de valider avec moi **par où on commence** et comment on sécurise les prochaines étapes. »

### 4. Ce que vous attendez concrètement de l'avocat (2–3 minutes)
...
3. **Un plan d'action et un calendrier**
   - « À la fin de ce rendez-vous, j'aimerais repartir avec :
     ...
     - et savoir comment on se parle (mails, rendez-vous). »

### 5. Vos 2–3 phrases de clôture

> « Je sais que je viens avec un dossier très préparé, mais je n'ai pas la prétention de faire votre travail : j'ai besoin que vous soyez **le pilote juridique** et que vous me disiez ce qui est réaliste, ce qui ne l'est pas, et dans quel ordre on avance. »

> « Je suis en **Aide Juridictionnelle**, je veux aussi que les choses soient claires sur vos honoraires éventuels en plus de l'AJ, et sur la façon dont on fonctionnera ensemble. »
...
## III. TALON-RÉPONSE — À REMPLIR PAR L'AVOCAT

> À laisser à l'avocat pour qu'il le remplisse (ou que son/sa secrétaire le fasse) et que tu repartes avec un minimum de visibilité.

| Champ | Réponse |
|---|---|
| **Nom de l'avocat** | |
| **Date du rendez-vous** | |
| **Acceptation de la mission AJ** | ☐ Oui ☐ Non (motif : …) |
| **Honoraires complémentaires (hors AJ)** | ☐ Oui ☐ Non — Montant / modalité : … |
| **Premières actions décidées** | 1. …  2. …  3. … |
| **Échéances clés prévues** | Référé : … / Expertise : … / Audience fond : … |
| **Modalités de contact** | Mail : … / Téléphone : … / Fréquence : … |
| **Prochain rendez-vous** | Date : … / Heure : … |
| **Remarques de l'avocat** | … |

---

> *Usage interne : cette fiche est pensée pour être lue par toi seul. Le PACK_ACCUEIL_AVOCAT_AJ et la SYNTHESE_GLOBALE (version juridique) restent les documents à laisser à l'avocat s'il les souhaite.*
