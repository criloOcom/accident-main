...
- **SIRET (104 103 262 00010)** : Présent dans les mêmes fichiers de configuration, ainsi que dans des actes clés comme `Refere Provision Assignation.md`, `⚖️ Requete Mandataire Ad Hoc.md` et `✉️ Police Plainte Complementaire ⚖️Contentieux.md`.
