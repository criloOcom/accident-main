...
3. Le nom réel « Catherine SORROCHE » apparaît-il encore en clair dans un document tokenisé (comme `MEMO_AUDIENCE_31072026.md` ou `Erratum`) ?
...
8. Le token `[**[Le Prénom du Préposé]**]` est-il listé dans le `README.md` du dossier `🧠 Memory/🗂️ Tokens/` ?

9. Le script `batch_anonymize.py` contient-il les règles de substitution pour `"« Ayoub »"` et `"Ayoub"` ?

10. Reste-t-il des mentions de « Ayoub » en clair dans le corps du texte de `🔍 Requete Article 145 CPC.md` ?

---

## 2. Cibles de Responsabilité — SAS HB BARBER (Q11–Q20)

11. L'introduction de l'acte `⚖️ Assignation Refere Provision.md` (ligne 32) vise-t-elle désormais la SAS HB BARBER au lieu de la SAS Les Mauvais Garçons (LMG) ?

12. La liste des défendeurs (partie "CONTRE :") dans `⚖️ Assignation Refere Provision.md` (lignes 52-56) désigne-t-elle la SAS HB BARBER en premier défendeur ?
...
15. La `17 ⚖️ Requete Mandataire Ad Hoc.md` vise-t-elle la SAS HB BARBER ou la SAS Les Mauvais Garçons en partie adverse ?
...
20. Existe-t-il un erratum d'identité (`📜 Erratum Correction Identite Societe.md`) visant à corriger l'erreur de désignation initiale ?
...
24. Le document Reel `⚖️ Assignation Refere Provision.md` a-t-il vu ses tokens résolus avec les identités réelles uniformisées ?
