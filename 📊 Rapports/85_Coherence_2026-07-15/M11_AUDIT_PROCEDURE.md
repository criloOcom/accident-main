...
- [ ] **[INFO] Délai Assignation Référé - Audience (J+32 à J+63) :**
  ...
  Fichiers : `⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/📋 Preparation Foix/Mémo - Audience 31-07-2026.md` et `Référé - Assignation Provision.md`
...
- [ ] **[INFO] Prescription de l'action en responsabilité (10 ans) :**
  ...
  Fichier : `⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/📜 Contentieux civil/Conclusions au Fond - TJ Foix.md` (ligne 102)
...
- [ ] **[MINEUR] Chronologie des Mises en demeure (J+31) et Assignation (J+32) :**
  ...
  Fichiers : `⚖️ Actes/🔑 Token/✉️ Courriers/📜 Mises en demeure/✉️ Courrier - SAS.md` et `⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/📜 Contentieux civil/Référé - Assignation Provision.md`
...
- [ ] **[CRITIQUE] Obsolescence / Anachronisme : Mention d'actes futurs dans des documents passés :**
  ...
  Fichier : `⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/👮 Contentieux penal/Constitution - Partie Civile.md` (lignes 62, 186, 218)
...
- [ ] **[INFO] Dépôt du rapport d'expertise et Conclusions au Fond :**
  ...
  Fichier : `⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/📜 Contentieux civil/Conclusions au Fond - TJ Foix.md`
