...
<!-- Breadcrumb -->
*[🏠](../../README.md) › [📊 Rapports](../README.md) › [85_Coherence_2026-07-15](../../%E2%9A%96%EF%B8%8F%20Actes/%F0%9F%94%91%20Token/README.md) › M06_AUDIT_CONTRE_EXPERTISE*
<hr>
<!-- /Breadcrumb -->

# M06 — Audit de la Contre-Expertise Médicale

## 1. Demande de contre-expertise dans l'assignation
- [x] **Vérification :** La demande de contre-expertise est-elle formulée dans l'assignation ?
- **Statut :** **CRITIQUE**
- **Constat :** FICHIER `⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/J+32 ⚖️ Assignation Refere Provision.md` (et autres fichiers de l'assignation) ne mentionne aucune demande de contre-expertise. L'assignation sollicite uniquement une **expertise médicale** judiciaire initiale (sur le fondement de l'article 145 du CPC) mais ne formule pas de demande de *contre-expertise*.
- **Note :** La mention d'une éventuelle contre-expertise apparaît uniquement de manière anticipée dans l'évaluation des Frais Divers (`⚖️ Actes/🔑 Token/💰 Etudes indemnisation/J+39 📊 Evaluation Dintilhac Consolidee.md`, ligne 114 et `📊 Rapports/40_Indemnisation_Dintilhac/20260708_Rapport_Baremique_Dintilhac.md`, ligne 44) pour un montant provisionné dans la demande globale, mais pas formellement sollicitée dans l'assignation.

<hr><hr>

## 2. Motifs de contestation et conclusions de l'expertise UMJ
...
## 3. Honoraires de l'expert
- [x] **Vérification :** Les honoraires mentionnés sont-ils cohérents avec les barèmes en vigueur ?
- **Statut :** **INFO**
- **Constat :** Les honoraires d'expertise médicale sont mentionnés dans les conclusions au fond (`⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/J+XX 📜 Conclusions au Fond TJ Foix.md`, ligne 257) pour un montant de **1 000 €**. Ce montant est réaliste pour une expertise médicale judiciaire classique en nomenclature Dintilhac, bien qu'il s'agisse de frais de l'expertise initiale et non spécifiquement d'une contre-expertise. Dans `J+39 📊 Evaluation Dintilhac Consolidee.md`, une enveloppe globale de 3 000 € de Frais Divers est demandée pour couvrir "kinésithérapie 3x/semaine, déplacements, frais dossier, contre-expertise éventuelle".

<hr><hr>

## 4. Choix du cabinet expert (CHUM TOULOUSE)
...
Cependant, l'expertise UMJ est bien prévue à **Toulouse** (`⚖️ Actes/🔑 Token/📂 Preuves officielles/J+167 📁 Preparation Expertise UMJ.md`), ce qui est cohérent avec la localisation de la victime (`⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/J+47 🚔 PV Audition Plainte Complementaire Foix.md`). L'expert judiciaire désigné (Dr X) est inscrit près la Cour d'appel de Toulouse (`20270529 ⚖️ Rapport Expertise Médicale.md`), également cohérent. L'acronyme "CHUM TOULOUSE" fourni dans la demande est une hallucination.

<hr><hr>

## 5. Délais et calendrier de procédure
- [x] **Vérification :** La contre-expertise a-t-elle un impact sur le calendrier de procédure ?
- **Statut :** **INFO**
- **Constat :** Inconnu en l'état. Aucune contre-expertise n'ayant été formellement demandée ni ordonnée à ce stade, il n'y a pas d'impact documenté sur le calendrier de procédure existant (`⚖️ Actes/🔑 Token/🗂️ Organisation/J+32 📅 Calendrier Procedure.md`).

<hr><hr>

## TODO Actions Correctives
