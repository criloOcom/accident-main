...
- **Statut :** **CRITIQUE**
- **Constat :** FICHIER `⚖️ Actes/🔑 Token/⚖️ Actes proceduraux/⚖️ Assignation Refere Provision.md` (et autres fichiers de l'assignation) ne mentionne aucune demande de contre-expertise. L'assignation sollicite uniquement une **expertise médicale** judiciaire initiale (sur le fondement de l'article 145 du CPC) mais ne formule pas de demande de *contre-expertise*.
