...
**Q17.** Les liens brisés dans `📊 Rapports/70_Technique_Repo/RAPPORT_ETAPE_POST_EMAIL_MAIRE_20260710.md` vers d'anciens fichiers `01 ⚖️ Assignation.md` pointent-ils désormais vers les fichiers corrects `⚖️ Assignation Refere Provision.md` dans 📜 Contentieux civil/ ?
...
**Q19.** Vérifie que les demandes de provision (15 000 €) sont bien dans des actes SÉPARÉS :
   - `⚖️ Assignation Refere Provision.md` (fondée sur art. 835 al. 2 CPC)
   - `⚖️ Projet Ordonnance Refere.md` (fondée sur art. 835 al. 2 CPC)
...
**Q34.** L'ordonnance projetée 145 CPC mentionne-t-elle HB BARBER (au lieu de LMG) comme destinataire des mesures ? Vérifie le fichier `⚖️ Actes/👤 Reel/⚖️ Actes proceduraux/📜 Contentieux civil/⚖️ Ordonnance sur Requete Art. 145 CPC.md`.
