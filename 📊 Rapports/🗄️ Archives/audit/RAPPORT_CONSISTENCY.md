...
<!-- Breadcrumb -->
[🏠](../../../README.md) › [📊 Rapports et Analyses](../../README.md) › [📁 🗄️ Archives](../README.md) › [📁 audit](./README.md) › RAPPORT CONSISTENCY
<!-- /Breadcrumb -->
...
Remplacement de la chaîne `[Adresse a completer]` par `[Adresse à compléter]` dans tous les fichiers Markdown du dossier `⚖️ Actes/✉️ Courriers/`. L'écriture `[Adresse à compléter]` fait partie de la liste des tokens acceptés.
