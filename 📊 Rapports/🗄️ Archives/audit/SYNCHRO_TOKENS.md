...
description: "Une analyse programmatique a été effectuée pour comparer les tokens utilisés dans `app/batch_anonymize.py` avec ceux documentés dans [🧠 Memory/TOKEN MAP.md](../../../%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md)."
type: rapport
---
...
<!-- Breadcrumb -->
[🏠](../../../README.md) › [📊 Rapports et Analyses](../../README.md) › [📁 🗄️ Archives](../README.md) › [📁 audit](./README.md) › SYNCHRO TOKENS
<!-- /Breadcrumb -->
...
Une analyse programmatique a été effectuée pour comparer les tokens utilisés dans `app/batch_anonymize.py` avec ceux documentés dans [🧠 Memory/TOKEN MAP.md](../../../%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md).
