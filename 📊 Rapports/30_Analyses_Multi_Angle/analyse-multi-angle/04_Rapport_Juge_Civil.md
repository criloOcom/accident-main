...
2. **La faute de la victime** : Il n'est pas démontré que **[La Victime]** ait eu un comportement anormal ou fautif lors de l'utilisation de la vasque (par exemple en s'y suspendant de tout son poids). Sans preuve formelle d'un tel comportement de la part de la victime, la SAS ne peut arguer d'aucune exonération.
