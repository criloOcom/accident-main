...
---
<!-- Breadcrumb -->
*[🏠](../README.md) › [🧠 Memory](./README.md) › Mini Calendrier Procedure*
<hr>
<!-- /Breadcrumb -->
...
| Date | Événement | Voie | Statut | Commentaires |
|------|-----------|------|--------|--------------|
| 29/05/2026 | **Accident** au salon « Les Mauvais Garçons » (Foix) | Faits | ✅ FAIT | Plaie main droite, ITT 56 j. |
| 01/06/2026 | **Mail du Maire adjoint** (B. Tavella) — signalement Préfecture/CODAF/IT | Admin | ✅ FAIT | Promesse de saisines administratives. |
| 02/06/2026 | **Plainte initiale** / PV n°2026/015967 (Toulouse) | Pénal | ✅ FAIT | |
| 29/06/2026 | **Mises en demeure** LRAR (SAS, dirigeants, propriétaire) | Civil | ✅ FAIT | LRAR SAS/dirigeants NPAI, proprio signé. |
...
| **15/07/2026 (matin)** | **Requête art. 145 CPC** TJ Foix (assurance + vidéos) | Civil / probatoire | ✅ PROJET PRÊT | À déposer lors du déplacement (semaine 27/07). |
| **15/07/2026 (matin)** | **Demande AJ totale** BAJ TJ Foix | AJ | 🏗️ EN COURS | Dépôt BAJ reprogrammé semaine 27/07. |
...
| Date | Événement | Voie | Statut | Commentaires |
|------|-----------|------|--------|--------------|
| **27/07/2026** | **🔴 DÉPLACEMENT FOIX** — Dépôt AJ + Complément PV | Mixte | 🏗️ EN COURS | Voir ci-dessous. |
| 27/07/2026 (matin) | **Dépôt dossier AJ totale** au BAJ du TJ Foix | AJ | 🏗️ EN COURS | Apporter fiche INPI/INSEE HB BARBER + justificatifs. |
| 27/07/2026 (après-midi) | **Audition / Complément PV** Commissariat Foix | Pénal | 🏗️ EN COURS | Verser fiche INPI/INSEE HB BARBER. Solliciter vérifications OPJ (visite contrôle <700m + réquisition attestation RC art. 77-1-1 CPP). ❌ Pas de confrontation directe. ❌ Pas d'accompagnement physique au salon. |
| __/__/2026 | **Relance Maire Tavella** si pas de réponse | Admin | ⏳ À FAIRE | Mail court de suivi. |
| __/__/2026 | **Envoi courrier 41** — Préfecture/CODAF (LRAR) | Admin | ⏳ À FAIRE | Modèle validé avocat. |
| __/__/2026 | **Envoi courrier 42** — Inspection du travail (LRAR) | Admin | ⏳ À FAIRE | Modèle validé avocat. |
...
> **Note :** Document de travail interne. Met à jour le tableau de bord dans [TODO.md](TODO.md) après chaque action.