...
- **Défaut** : tous les liens internes utilisent des chemins absolus `/Actes/...` (ex. `/Actes/Token/Actes_proceduraux/Contentieux_civil/TJ Foix - TJ Foix - Référé Provision - Assignation.md`) → morts sur GitHub/HTML.

- **Correction** : remplacer `](/Actes/%60%20par%20%60%5D%28../Actes/%60%20%28et%20%60%5D%28/Rapports/%60%20par%20%60%5D%28../Rapports/%60%20si%20pr%C3%A9sent).

- **Impact** : 164 liens réparés. À rejouer `check_consistency.py` après.

### I.2 — P0-2 — [Actes/README.md](../../Actes/Token/README.md) : dossiers renommés  [SCRIPT]
...
- **Note** : vérifier aussi `Preuves_officielles/` existe bien sous `Token/`.

### I.3 — P0-3 — Liens jurisprudence : sous-dossier `Jurisprudence/README.md` manquant  [SCRIPT]
- **Cibles** :

  - [Actes/Token/Analyses_juridiques/Note - Analyse Responsabilités Légales.md](Actes/Token/Analyses_juridiques/13%20%F0%9F%93%9C%20Responsabilites%20legales.md) (L92-98, 4 liens `../../../Lois/X.md`)
  - [Actes/Token/Analyses_juridiques/Note - Stratégie Jurisprudentielle.md](Actes/Token/Analyses_juridiques/14%20Strat%C3%A9gie%20jurisprudentielle.md) (L30-37, ~11 liens `../../Lois/X.md`)
...
- **Vérifier** cible existe : [Lois/Jurisprudence/README.md89-18.422_CourCassation.md](../../Lois/Jurisprudence/Responsabilité_du_fait_des_choses/89-18.422_CourCassation.md) ✅ présent.

### I.4 — P0-4 — `TJ Foix - TJ Foix - Référé Provision - Assignation.md` : chemins d'annexe  [SCRIPT]
- **Cibles** : `Actes/{Token,Reel}/Actes_proceduraux/TJ Foix - TJ Foix - Référé Provision - Assignation.md` (L106-126, 347-349)

- **Correction appliquée (juil. 2026)** : les 3 ANNEXES ont été déplacées dans [Lois/Jurisprudence/](../../Actes/Token/README.md) — voir `63-13.613`, `90-14.591`, `11-13.384`.

### I.5 — P0-5 — `05 Note - Dossier Spécial CERFA.md` : 6 liens `file://` cassés  [MANUEL + SCRIPT]
- **Cibles** : `Actes/{Token,Reel}/Organisation/05 Note - Dossier Spécial CERFA.md` (L43-45)

- **Défaut** : pointe vers `file:///.../Courriers/26 Témoin Client - Attestation.md` etc. → le 📋 est faux (fichiers réels = `📧`) ET `file://` absolu interdit.

- **Deux options** :

  - (a) Renommer les fichiers cibles `26/27/28 📋 ...` → `26/27/28 📧 ...` (à valider avec l'utilisateur car touche nommage).
  - (b) Corriger les liens en chemins relatifs `../Courriers/26 📧Témoin Client - Attestation.md` (sans `file://`).
- **Recommandation** : option (b) (non destructif). Les fichiers réels sont `26 📧Témoin Client - Attestation.md`, `27 📧Pompier SAMU - Attestation.md`, `28 📧✉️ Employé - Attestation.md` ✅.
...
- **Cibles** (~15) : tous les `Actes/Preuves officielles/{date}*/README.md`, [Actes/Token/Archives/annexes/README.md](../../Actes/Token/README.md), [Actes/📎 Annexes/README.md](../../Actes/Token/README.md), `.dev/jules_recommandations/README.md`.
...
- **Cibles** : 20 README de sous-dossiers (`Actes/Preuves officielles/{date}*/README.md` L7 : `🔙 [📁 ...](../README.md)`) + [Rapports/RAPPORT_NAVIGATION_INTERACTIVE_20260711.md](RAPPORT_NAVIGATION_INTERACTIVE_20260711.md) L78 (`Retour à l'accueil`).
...
- **Action** : archiver dans [Rapports/Archives](../../Actes/Token/README.md) ou supprimer (après confirmation qu'il ne sert plus). Génère 45 liens fantômes.
...
- **Correction** : créer [Actes/Preuves officielles/README.md](../../Actes/Token/README.md) (frontmatter `type: readme`) listant les 13 sous-dossiers.
...
- **Action** : relier depuis un index ([Rapports/README.md](../../Actes/Token/README.md)) ou archiver dans [Rapports/Archives](../../Actes/Token/README.md).
...
- **Cible** : [Actes/Reel/Preuves_officielles/README.md](../../Actes/Token/README.md) (3 lignes).
