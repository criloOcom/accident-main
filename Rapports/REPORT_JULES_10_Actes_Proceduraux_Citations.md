...
## Introduction
Ce rapport a pour but de vérifier si les projets d'assignation et de plainte citent bien les nouvelles pièces récentes (INPI, LRAR 18/07, Kiné, SAMU, Témoin).
Le dossier a récemment vu l'ajout de nouvelles preuves essentielles qui viennent étayer l'action de la victime, tant sur le plan civil que pénal, mais dont la bonne retranscription dans les bordereaux annexés aux actes est cruciale.
...
Il apparaît clairement que le **TJ Foix - Bordereau Unifié.md** n'a pas été pleinement mis à jour avec les pièces INPI ni les LRAR du 18/07. Par ailleurs, les actes procéduraux de fond (Assignation, Constitution de Partie Civile) ont conservé leurs propres petits bordereaux obsolètes au lieu de s'aligner sur la PIECES MAP.
