...
# 📊 Rapport Jules #02 — Audit Responsabilité Personnelle des Dirigeants & Faute Détachable
...
L'analyse combinée des textes de loi et de la jurisprudence de la Cour de cassation confirme la **validité absolue de notre stratégie juridique** consistant à engager la responsabilité personnelle et patrimoniale du Président (M. Hamza BERGUIGA) et de la Directrice Générale (Mme Catherine SORROCHE) de la SAS HB BARBER, en parallèle de la responsabilité de la société exploitante.

Cette responsabilité s'appuie sur deux piliers juridiques complémentaires :
1. **La responsabilité civile des dirigeants de SAS envers les tiers** (Articles L. 227-8 et L. 225-251 du Code de commerce), articulée avec la définition de la **faute détachable des fonctions** dégagée par l'arrêt fondateur **SATI** de la Cour de cassation (Cass. Com., 20 mai 2003, n° 99-17.092).

2. **La responsabilité délictuelle personnelle de droit commun** (Article 1240 du Code civil), fondée sur les fautes personnelles commises post-accident (refus d'information d'assurance, entrave au droit d'action directe de l'article L. 124-3 du Code des assurances, allégations mensongères et altération de preuves).
...
> *« La faute commise intentionnellement par le dirigeant, d'une particulière gravité, incompatible avec l'exercice normal des fonctions sociales. »* (Cass. Com., 20 mai 2003, n° 99-17.092).

Dans notre dossier, le refus délibéré et prolongé pendant plusieurs semaines de déclarer un accident corporel grave (section tendineuse et nerveuse de l'index droit avec 55 jours d'arrêt de travail), la rétention des coordonnées de l'assurance RC Pro et les manœuvres visant à dénier toute responsabilité entrent exactement dans cette qualification :
- **Intentionnalité** : Les dirigeants ont reçu plusieurs LRAR formalisées à leurs domiciles et au siège.

- **Gravité particulière** : Privation du tiers lésé de son droit légal d'action directe (Art. L. 124-3 C. ass.) et blocage du recours tiers de la CPAM.

- **Incompatibilité avec la gestion sociale** : Un dirigeant d'Établissement Recevant du Public (ERP) ne peut pas décemment faire disparaître les éléments d'assurance destinés à la protection des clients.
...
- Obtenir sous astreinte (150 € / jour de retard) l'attestation d'assurance RC Pro de la SAS HB BARBER et une copie certifiée du bail commercial.

- Fixer contradictoirement l'identité de l'assureur pour exercer l'action directe (Art. L. 124-3 C. ass.).
...
### Actions d'Enrichissement des Actes et de la Mémoire
- [ ] **Action 1** — Insérer la citation formelle de l'Arrêt SATI (Cass. Com., 20 mai 2003, n° 99-17.092) dans le projet d'Assignation en référé 145 CPC (`Actes/Token/Actes_proceduraux/01_Assignation/`).

- [ ] **Action 2** — Compléter le projet d'Assignation en référé avec le moyen fondé sur le faisceau de présomptions de mauvaise foi (Article 1382 du Code civil : fermeture 30j, disparition vidéosurveillance, retrait TV).
...
- [ ] **Action 6** — Invoquer l'Article 700 du CPC pour réclamer le remboursement intégral des frais d'investigation occasionnés par l'inertie des dirigeants.

- [ ] **Action 7** — Rédiger une note de synthèse à destination de l'avocat consacrée à la responsabilité personnelle du Président et de la Directrice Générale.
...
- [ ] **Action 13** — Mettre à jour le calendrier des échéances de la mise en demeure de 15 jours des LRAR du 18/07/2026.

- [ ] **Action 14** — Vérifier la stricte conformité des liens Légifrance cités.

- [ ] **Action 15** — Valider le rapport avec les agents de l'équipe.

<hr><hr>

## V — SOURCES & CITATIONS (SOURCES OFFICIELLES GOVERNEMENTALES)

Tous les textes législatifs et décisions de jurisprudence ci-dessous sont adossés aux sources officielles (Légifrance & Judilibre) :

### Textes Législatifs & Réglementaires
- **Article L. 227-8 du Code de commerce** (Responsabilité des dirigeants de SAS)  
  [Consulter sur Légifrance - legifrance.gouv.fr/codes/article_lc/LEGIARTI000006227036/](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006227036/)
- **Article L. 225-251 du Code de commerce** (Responsabilité envers la société et les tiers)  
  [Consulter sur Légifrance - legifrance.gouv.fr/codes/article_lc/LEGIARTI000006226328/](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006226328/)
- **Article 1240 du Code civil** (Responsabilité extracontractuelle de droit commun)  
...
- **Article L. 124-3 du Code des assurances** (Droit d'action directe du tiers lésé)  
  [Consulter sur Légifrance - legifrance.gouv.fr/codes/article_lc/LEGIARTI000006792607/](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006792607/)
- **Article 145 du Code de procédure civile** (Mesures d'instruction in futurum et référé-communication)  
...
- **Article 700 du Code de procédure civile** (Frais irrépétibles et équité)  
  [Consulter sur Légifrance - legifrance.gouv.fr/codes/article_lc/LEGIARTI000038936359/](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000038936359/)
...
- **Cour de cassation, Chambre commerciale, 20 mai 2003, N° de pourvoi : 99-17.092** (Arrêt *SATI* — Définition de la faute détachable/séparable des fonctions)  
  [Consulter la décision officielle sur Légifrance - legifrance.gouv.fr/juri/id/JURITEXT000007047369/](https://www.legifrance.gouv.fr/juri/id/JURITEXT000007047369/)
- **Cour de cassation, Assemblée Plénière, 25 février 2000, N° de pourvoi : 97-17.378** (Arrêt *Costedoat* — Immunité du préposé et responsabilité du dirigeant)  
  [Consulter la décision officielle sur Légifrance - legifrance.gouv.fr/juri/id/JURITEXT000007041793/](https://www.legifrance.gouv.fr/juri/id/JURITEXT000007041793/)
