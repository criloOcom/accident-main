...
| B.9 | Bordereau unifié | ✅ | 7 groupes (A→G) présents et cohérents dans `TJ Foix - Bordereau Unifié.md`. |
...
| B.13 | Arborescence courriers | ✅ | 11 sous-dossiers dans `Courriers/` — tous avec fichiers. Aucun dossier vide. |
