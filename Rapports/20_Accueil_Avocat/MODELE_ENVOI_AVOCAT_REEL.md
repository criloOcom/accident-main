...
---
<!-- Breadcrumb -->
*[🏠](../../README.md) › [Rapports](../README.md) › [20 Accueil Avocat](./README.md) › MODELE ENVOI AVOCAT REEL*
<hr>
<!-- /Breadcrumb -->

# Option A — Avocat déjà désigné (AJ)

**Objet** : Dossier accident corporel — [NOM_VICTIME] c. SAS [NOM_SAS] — TJ Foix — Demande de prise en charge
...
[NOM_VICTIME]
[TEL_VICTIME] — [EMAIL_VICTIME]

<hr><hr>

# Option B — BAJ / Bâtonnier (demande de désignation)

**Objet** : Demande de désignation d'avocat au titre de l'aide juridictionnelle — Dossier accident corporel — [NOM_VICTIME] c. SAS [NOM_SAS] — TJ Foix
...
Le dossier est en état d'être plaidé au fond devant le TJ de Foix (projet de conclusions, note stratégique et référentiel chiffré complets). Une information judiciaire pénale est également en cours (Parquet de Foix, réquisitoire introductif double qualification 222-19/222-20 CP).
...
**Placeholders** :
`[NOM_VICTIME]` — Nom et prénom
`[NOM_SAS]` — Raison sociale de l'exploitation
`[ASSUREUR_RC]` — Assureur RC
