...
|---|---|---|---|---|
| FGTI / CIVI | Infraction caractérisée (ITT ≥ 1 mois ou IP) | 3 ans (prorogeable) | Réparation intégrale | Caractérisation matérielle de l'infraction |
| Action directe RC | Identification de l'assureur RC Pro de la SAS | 10 ans | Plafonds RC Pro | Défaut d'assurance ou résiliation |
| État (SARVI) | Décision allouant D&I impayée | - | 3 000 € (ou 30% au-delà) | Plafond très bas, subsidiaire |
| Art. 700 CPC | Condamnation de la partie adverse | - | Appréciation du juge | Insolvabilité du condamné |
...
-   **Délai** : Prescription décennale classique en responsabilité civile corporelle.

-   **Montant max** : Plafonds de garantie du contrat RC Pro (généralement très élevés pour les dommages corporels).

-   **Risque** : Assurance potentiellement inexistante (défaut d'assurance) ou résiliée pour non-paiement des primes par la SAS.
...
-   **Montant max** : SARVI (3 000 € ou 30% au-delà). L'action en responsabilité de l'Etat nécessite une faute lourde.

-   **Risque** : Voie très subsidiaire et plafonnée.
...
-   **Montant** : Appréciation souveraine du juge (généralement entre 1 500 € et 3 000 € en référé, davantage au fond).

-   **Risque** : Insolvabilité de la partie condamnée (SAS). Ces frais ne sont pas pris en charge par le FGTI au titre des préjudices.
...
1.  **Priorité 1 : L'Assureur RC Pro (Action directe)**
    ...
    -   *Action* : Référé Art. 145 CPC pour forcer la communication de l'attestation d'assurance, suivi de l'action directe (Art. L. 124-3 C. Assur.).
2.  **Priorité 2 : Les Dirigeants à titre personnel**

    -   *Pourquoi ?* Risque de défaut d'assurance de la SAS. Il faut démontrer la faute détachable des dirigeants (imprudence grave, défaut de souscription d'assurance obligatoire ou violation délibérée des obligations de sécurité).
    -   *Action* : Mise en cause personnelle.
3.  **Priorité 3 : La CIVI / FGTI**
...
-   **Dès obtention des coordonnées de l'assurance** : Assignation en référé-provision (Art. 835 CPC) contre la SAS et son assureur pour obtenir une provision (ex: pour couvrir la facture SOS Main de 790,23 € et compenser la perte de gains).

-   **En cas de défaut d'assurance avéré** : Saisine immédiate de la CIVI pour obtenir une provision et la désignation d'un expert judiciaire.