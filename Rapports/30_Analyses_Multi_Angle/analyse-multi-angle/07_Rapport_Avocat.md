...
---
<!-- Breadcrumb -->
*[🏠](../../../README.md) › [Rapports](../../README.md) › [30 Analyses Multi Angle](../README.md) › [analyse-multi-angle](./README.md) › 07 Rapport Avocat*
<hr>
<!-- /Breadcrumb -->
...
Ce montant est justifié par les premières évaluations des préjudices, notamment les pertes de revenus actuelles, le déficit fonctionnel temporaire et les souffrances endurées (intervention chirurgicale).
...
La question centrale sera la valorisation de l'**Incidence Professionnelle** (indépendant dont l'outil principal est la main) et du **Préjudice d'Agrément** (le codage informatique étant pratiqué de manière intensive à titre de loisir exclusif, estimé à 4 000 €).

**Chances de succès :** Très élevées sur le principe de la responsabilité civile de la SAS. Le risque principal réside dans le recouvrement en cas d'absence d'assurance et d'insolvabilité de la société, nécessitant alors l'activation de la garantie du FGTI/CIVI (art. 706-3 CPP) ou la recherche de la responsabilité du dirigeant.
