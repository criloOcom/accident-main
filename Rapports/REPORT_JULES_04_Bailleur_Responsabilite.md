...
---
<!-- Breadcrumb -->
*[🏠](../README.md) › [Rapports](./README.md) › REPORT JULES 04 Bailleur Responsabilite*
<hr>
<!-- /Breadcrumb -->
...
- **SIREN (104 103 262)** : Présent dans `.dev/app/generate_real_versions.py`, `.dev/app/batch_anonymize.py`, [Memory/TOKEN MAP.md](../Memory/TOKEN MAP.md), et les fiches de tokens (`token-exploitation-hb-siren.md`, etc.).
