...
---
<!-- Breadcrumb -->
*[🏠](../README.md) › [Rapports](./README.md) › 20260718 RAPPORT PLAN DEPLACEMENT*
<hr>
<!-- /Breadcrumb -->
...
En explorant le dossier, plusieurs fausses mentions « ✅ Déposé », « Transmis » ou « Envoyé » ont été détectées, notamment concernant :
...
- **Ce qu'il faut éviter** : Repartir sans preuve formelle de dépôt. Ne pas engager de débat sur le fond du dossier avec le greffier.
...
- **Documents à apporter** :
  ...
  - Formulaire CERFA de demande d'AJ complété.
  - Récépissé de la requête Art. 145 CPC (obtenu à l'étape précédente).
  - Pièces justificatives : avis d'imposition N-1, déclarations URSSAF des 12 derniers mois, justificatif de domicile (- 3 mois), pièce d'identité en cours de validité.
- **Ce qu'il faut demander** : Un récépissé de dépôt (avec date, n° d'enregistrement et cachet) et un traitement accéléré du dossier.

- **Ce qu'il faut dire** : « Je dépose une demande d'aide juridictionnelle totale. Je sollicite un traitement accéléré en raison de l'urgence : les preuves vidéos de l'accident risquent d'être détruites avant le 15 août 2026. »

- **Ce qu'il faut éviter** : Oublier de mentionner l'urgence liée à la vidéosurveillance.
...
- **Documents à apporter** : Carnet de notes, smartphone.

- **Ce qu'il faut demander** : Si de nouveaux témoins/voisins sont présents, leur demander une attestation sur l'honneur avec copie de leur pièce d'identité.

- **Ce qu'il faut dire** : Se présenter courtoisement si interpellé.

- **Ce qu'il faut éviter** : Toute provocation ou escalade verbale avec [**[Le Président du Nouvel Exploitant]**] ou le personnel. Ne pas insister s'ils refusent de coopérer.
...
- **Documents à apporter** : Enveloppes prêtes contenant l'Erratum formel (et relances/mises en demeure si applicables).

- **Ce qu'il faut demander** : Preuves de dépôt (bordereaux physiques ou scannés).

- **Ce qu'il faut dire** : « Je souhaite affranchir ces courriers en recommandé avec accusé de réception. »
...
- **Ce qu'il faut dire** : « Je viens prendre des nouvelles suite à mon signalement pour accident lié à un équipement non conforme. »

- **Ce qu'il faut éviter** : Devenir insistant. Privilégier une trace écrite (demande de récépissé ou courriel récapitulatif post-visite).

<hr><hr>

## III — CHECK-LIST SYNTHÉTIQUE IMPRIMABLE (RECTO/VERSO)

> **Poids estimé du sac :** ~1,5 à 2 kg (3 jeux de ~58 pages + originaux + classeurs).

### MATIN : TRIBUNAL JUDICIAIRE
- [ ] **Greffe civil :** Requête Art. 145 CPC (2 exemplaires) + annexes associées.

- [ ] **BAJ (Aide Juridictionnelle) :**

  - [ ] Formulaire CERFA d'AJ complété.
  - [ ] Avis d'imposition N-1 et déclarations URSSAF (12 derniers mois).
  - [ ] Pièce d'identité (CNI).
  - [ ] Justificatif de domicile de moins de 3 mois.
  - [ ] Récépissé de la requête Art. 145.

### MIDI : LIEU DE L'ACCIDENT
- [ ] **Matériel :** Smartphone (chargé) / appareil photo, carnet, stylo.

- [ ] **Constat :** Photos extérieures, note sur d'éventuelles nouveautés (caméras, occupation).

### APRÈS-MIDI : COMMISSARIAT & POSTE
- [ ] **Commissariat :**

  - [ ] 3 jeux complets du dossier (Note personnelle, Erratum formel, Bordereau de pièces).
  - [ ] Originaux pour présentation (si demandé).
  - [ ] Pièce d'identité.
- [ ] **Poste :**

  - [ ] Courriers LRAR préparés (dont Erratum à expédier en double).
  - [ ] Moyen de paiement.

### INDISPENSABLES
- [ ] Eau, en-cas, batterie externe pour smartphone.