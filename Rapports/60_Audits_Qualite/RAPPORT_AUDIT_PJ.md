...
---
<!-- Breadcrumb -->
*[🏠](../../README.md) › [Rapports](../README.md) › [60 Audits Qualite](./README.md) › RAPPORT AUDIT PJ*
<hr>
<!-- /Breadcrumb -->
...
2. **[URGENT] Numériser les AR NPAI physiques**
   ...
   - Scanner les 4+ AR retournés (SAS, Président, Directrice, Propriétaire) → `Preuves_officielles/20260629_*_AR_NPAI_*.md`
   - Mettre à jour PIECES MAP.md

3. **[URGENT] Commander l'extrait Kbis officiel**

   - Via infogreffe ou INPI (gratuit) → déposer dans `Preuves_officielles/`
...
---
*Rapport généré le 10/07/2026 — Audit des 33 courriers (03→35) par extraction des sections PIECES JOINTES et vérification physique dans `Preuves_officielles/`.*