...
---
<!-- Breadcrumb -->
*[🏠](../../../README.md) › [Rapports](../../README.md) › [60 Audits Qualite](../README.md) › [audit](./README.md) › audit juritext*
<hr>
<!-- /Breadcrumb -->
...
**Périmètre :** [Actes/Token](../../../Actes/Token/README.md) (dossiers 01 à 06)  
...
### III.1 — ANOMALIE 1 — `05 🎯 Conclusions Refere.md` (ligne 85)
...
### III.2 — ANOMALIE 2 — `05 🎯 Conclusions Refere.md` (ligne 93)
...
Les anomalies suivantes, identifiées dans des audits précédents, sont **déjà corrigées** dans les fichiers `Token` actuels :
...
|---------|:------------:|:------------------:|
| `Actes_proceduraux/` | 14 | ❌ (2 anomalies dans `05 Conclusions Refere.md`) |
| `Courriers/` | 8 | ✅ |
| `Analyses_juridiques/` | 11 | ✅ |
| `Etudes_indemnisation/` | 16 | ✅ |
| `Organisation/` | 8 | ✅ |
| `Archives/` | 12 | ✅ |
