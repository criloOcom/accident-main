...
**Objectif** : Documenter l'ajout du dossier "20260710_Actualisation_Dossier_ERP" et mettre à jour les références du projet
...
### I.1 — Emplacement
```
Actes/Preuves officielles/20260710_Actualisation_Dossier_ERP/
```
...
- **Document** : [Actes/Token/Courriers/CODAF - Préfecture - Signalement.md](Actes/Token/Courriers/34%20%E2%9C%89%EF%B8%8F%20EMAIL%20Maire%20Foix%20-%20Police%20Municipale%20ERP.md)
...
```mermaid
gantt
    title Chronologie des Correspondances - Juillet 2026
    dateFormat  YYYY-MM-DD
    section Correspondances Mairie
    Email n°34 (ERP)           :a1, 2026-07-10, 1d
    section Actions Judiciaires
    Transmission dossier médical :b1, 2026-06-29, 1d
...
- Emplacement : [Rapports](../../Actes/Token/README.md)
...
- **Dossier créé** : 20260710_Actualisation_Dossier_ERP
...
- [ ] **Archiver les réponses** : Dans 20260710_Actualisation_Dossier_ERP/
```
...
3. **Commit GitHub** :
   ```bash
   cd /home/crilocom/accident-main
   git add Actes/Preuves officielles/20260710*
   git add Rapports/RAPPORT_DOCUMENTATION_NOUVEAU_DOSSIER_20260711.md
