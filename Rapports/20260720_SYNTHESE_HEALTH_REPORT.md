...
<!-- Breadcrumb -->
*[🏠](../README.md) › [Rapports](./README.md) › 20260720 SYNTHESE HEALTH REPORT*
<hr>
<!-- /Breadcrumb -->
...
- **Détails** : Le check remonte **11** écarts factuels vs `STRICT VARIABLES.md`.
  ...
  - Le numéro de LRAR réel `87001424863012T` apparaît en clair dans un fichier anonymisé `Token/Courriers/Police/Guide Orale.md` au lieu du token approprié.
