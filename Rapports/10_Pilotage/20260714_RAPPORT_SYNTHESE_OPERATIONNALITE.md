...
```mermaid
gantt
    title Plan d'Action "0 à 100" - Accident-Main
    dateFormat  YYYY-MM-DD
    axisFormat  %m-%d

    section Urgence Preuves (J+0 à J+30)
    Dépôt Req. 145 & AJ (Utilisateur) :crit, done, req1, 2026-07-15, 1d
    Constat Lieux & Plainte (Utilisateur) :crit, done, req2, 2026-07-15, 1d
    Relances Administratives (IA/Utilisateur) :req3, 2026-07-18, 3d
    Ordonnance 145 CPC (Tribunal) :crit, req4, 2026-07-30, 1d
    Saisie Vidéos (Commissaire) :crit, req5, 2026-08-10, 1d

    section Provision & Procédure (J+30 à J+100)
    Désignation Avocat AJ :proc1, 2026-08-05, 1d
    Assignation Référé (IA/Avocat) :proc2, 2026-08-15, 5d
    Signification Référé (Commissaire) :proc3, 2026-08-25, 2d
    Audience Référé :crit, proc4, 2026-09-15, 1d
    Ordonnance Référé & Exécution :proc5, 2026-09-30, 20d

    section Évaluation & Fond (J+100 à J+180)
    Expertise UMJ Purpan :crit, eval1, 2026-11-12, 1d
    Consolidation Médicale :eval2, 2026-12-12, 1d
    Assignation au Fond (IA/Avocat) :crit, eval3, 2027-01-12, 10d
```
