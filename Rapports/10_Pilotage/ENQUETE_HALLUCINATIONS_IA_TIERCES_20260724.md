...
2. **Confusion d'entités proches (cause n° 2).** Deux SAS successives au même endroit, deux dirigeantes au nom composé proche (Catherine SORROCHE / ANDISSAC), deux présidents. Sans fiche d'identité par entité sous les yeux, le modèle fusionne les entités (E5). C'est l'hallucination la plus dangereuse pour les documents transmis aux autorités.
...
3. D'où as-tu tiré l'affirmation « SAS HB BARBER immatriculée le 19 mai 2026 » ? Cite ta source exacte (fichier + ligne, ou pièce). Si tu ne peux pas la citer, explique comment ce chiffre est apparu dans ta réponse.

4. D'où as-tu tiré « gérance M. Sabir MOUNTASSER » pour HB BARBER ? Quelle pièce du dossier relie MOUNTASSER à HB BARBER ? (Réponse attendue : aucune.) Pourquoi as-tu fusionné deux sociétés distinctes ?
