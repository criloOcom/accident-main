...
LEGIARTI = {
    ...
    "2226 C. civ.": "LEGIARTI000019017259",
    "121-3 C. pén.": "LEGIARTI000006417208",
    "222-19 C. pén.": "LEGIARTI000024042643",
    "222-20 C. pén.": "LEGIARTI000024042640",
    "475-1 CPP": "LEGIARTI000044570107",
...
def main():
    ...
    files = {
        ...
        os.path.join(base, "archives", "ANALYSE_correction_juridique.md"): (False, False),
        os.path.join(base, "archives", "ANALYSE_Jurisprudence.md"): (False, False),
