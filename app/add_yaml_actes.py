...
YAML_MAP = {
    ...
    '03_Courrier SAS - V1.md': {
        ...
        'personnes': ['La Victime', 'L\'Exploitant du Commerce'],
        'tags': ['mise en demeure', 'SAS', 'assurance', 'LRAR'],
        'statut': 'final',
        'source': 'drive',
        'drive_id': None,
    },
    '04_Courrier Assureur - V1.md': {
        'titre': 'Action Directe Assureur RC (Art. L.124-3) — Mise en Demeure',
        'date': '2026-06-29',
        'type': 'acte',
        'categorie': 'procedure',
        'auteur': 'La Victime',
    ...
    '05_Courrier Proprietaire - V1.md': {
        ...
        'personnes': ['La Victime', 'Le Propriétaire des Murs', 'L\'Exploitant du Commerce'],
        'tags': ['mise en demeure', 'bailleur', 'assurance', 'LRAR'],
        'statut': 'final',
        'source': 'drive',
        'drive_id': None,
    },
    '06_Courrier President DG - V1.md': {
        ...
        'personnes': ['La Victime', 'Le Président de l\'Exploitation', 'La Directrice Générale de l\'Exploitation', 'L\'Exploitant du Commerce'],
        'tags': ['mise en demeure', 'dirigeants', 'assurance', 'faute détachable', 'LRAR'],
        'statut': 'final',
        'source': 'drive',
        'drive_id': None,
    },
