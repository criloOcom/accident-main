...
actes_dir = "⚖️_Actes"
token_dir = os.path.join(actes_dir, "🔑_Token")
reel_dir = os.path.join(actes_dir, "👤_Reel")
...
tokens = []
try:
    with open("🧠_Memory/TOKEN MAP.md", "r", encoding="utf-8") as f:
        content = f.read()
...
for rel_path in all_rel_paths:
    ...
    for link in links:
        ...
        if unquoted_link.startswith("file:///"):
            ...
            if "⚖️_Actes" in unquoted_link:
                unquoted_link = unquoted_link.split("⚖️_Actes")[1].lstrip("/")
