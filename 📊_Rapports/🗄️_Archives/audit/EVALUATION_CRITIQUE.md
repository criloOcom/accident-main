<!-- Breadcrumb -->
[🏠](../../../README.md) › [📊 Rapports et Analyses](../../README.md) › [📁 🗄️_Archives](../README.md) › [📁 audit](./README.md) › EVALUATION CRITIQUE
<!-- /Breadcrumb -->
...
*   **Sur le référé-provision (5 000 €) :** Le juge vous déboutera très probablement. L'article 835 du CPC exige une obligation *non sérieusement contestable*. Or, vous n'avez aucun constat d'huissier immédiat. Si la partie adverse déclare que la victime a trébuché, il y a une "contestation sérieuse". Le juge refusera la provision et vous renverra au fond.
*   **Sur l'argument du "paiement Wero de 15€" :** Vous affirmez que ce remboursement est un aveu implicite de responsabilité. Pour un juge, c'est juridiquement inexistant. C'est un geste commercial.
*   **Sur l'implication des dirigeants (Faute détachable) :** Le juge rejettera vos demandes contre les dirigeants à titre personnel. La négligence d'entretien d'un meuble ou l'absence de souscription d'une assurance *facultative* (pour un coiffeur) ne constitue pas une "faute détachable" des fonctions de dirigeant (qui requiert une faute intentionnelle d'une gravité exceptionnelle, comme l'arrêt SATI le précise pour une fraude).
...
Vous construisez un édifice juridique complexe, mais **vous n'avez aucune preuve matérielle des faits**.
Vous affirmez que le coiffeur "est monté sur la vasque", qu'elle a basculé, et qu'il y avait "une cassure préexistante". Sans constat d'huissier, sans photos datées du jour J, et sans témoignages (attestations Cerfa), votre dossier est vide. Le droit ne sert à rien si les faits ne sont pas prouvés.

❌ **ATTAQUER LE PROPRIÉTAIRE DES MURS EST HORS SUJET**
Invoquer l'article 1719 du Code civil contre le propriétaire des murs montre au juge que vous tirez "dans tous les sens" par peur de l'insolvabilité de la SAS. Un bac à shampoing est un équipement professionnel qui relève exclusivement de la responsabilité du locataire-exploitant.

💰 **L'ÉVALUATION DINTILHAC EST PRÉMATURÉE**
Évaluer un Déficit Fonctionnel Permanent (DFP) à 25 200 € à peine un mois après l'accident (l'ITT est toujours en cours fin juin), sans consolidation médicale et sans expertise, est prématuré et maladroit.
