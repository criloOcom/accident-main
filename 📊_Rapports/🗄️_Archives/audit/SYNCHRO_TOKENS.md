...
Une analyse programmatique a été effectuée pour comparer les tokens utilisés dans `app/batch_anonymize.py` avec ceux documentés dans [🧠_Memory/TOKEN MAP.md](🧠_Memory/TOKEN MAP.md).
