...
*   **Ordonnance sur Requête (Art. 145 CPC) :** Bien que la Requête (Pièce n°6) soit rédigée, il faut obtenir l'Ordonnance du juge pour imposer l'entrée dans les locaux professionnels sans le consentement du gérant et, si besoin, avec le concours de la force publique ou d'un serrurier.
...
*   **Acquisition des images :**
    *   Le délai de 30 jours (durée légale maximale de conservation des images de vidéosurveillance dans les lieux accueillant du public) étant dépassé depuis le 29 mai 2026, il y a urgence absolue (ou perte définitive).
    *   S'il existe encore un enregistrement, l'huissier ne peut en exiger la copie de lui-même sans mandat judiciaire (Ordonnance sur requête visant spécifiquement la conservation et la remise des images, ou réquisition de l'OPJ dans le cadre de la plainte).
    *   L'huissier sommera le gérant de consigner et figer (par extraction sur clé USB) la séquence du **29 mai 2026 aux alentours de 15h00**.
