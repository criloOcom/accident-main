<!-- Breadcrumb -->
[🏠](../../README.md) › [📊 Rapports et Analyses](../README.md) › RAPPORT NAVIGATION CITATIONS
<!-- /Breadcrumb -->
...
## Règle instituée
- **Règle #17** ajoutée dans `🧠_Memory/RULES.md` : liens obligatoires sur toute citation interne (dossier → `README.md` du dossier ; fichier → fichier).
...
- **2 hubs de gouvernance corrigés** (lus par tous les agents) :
  - `🧠_Memory/WORKFLOW.md` : citations `⚖️_Actes/archives/STRATEGIE_...` (dossier renommé) → `⚖️_Actes/🔑_Token/06_🗄️_Archives/🧠 STRATEGIE Contentieux Civil.md` (+ Pénal), liées.
  - `🧠_Memory/RULES.md` : même correction.
...
- **Conventions illustratives** (à ignorer) : `🧠_Memory/RULES.md #12`, `⚖️_Actes/...` (listage de dossiers dans AGENTS.md), `*.md`, `{00-06}`, `XXX.md`.
- **Docs d'archive / journaux historiques** (`📊_Rapports/🗄️_Archives/...`, `🧠_Memory/STATUS.md`) : chemins historiques morts (fichiers renommés/supprimés, ex. `📊_Rapports/expertise/20260707 Mémoire juridique Glose.md` jamais importé, docs fantômes `RAPPORT_JURISPRUDENCES.md`).
- **Quelques docs fantômes connus** déjà signalés dans l'audit Hermès (ex. `🧠_Memory/RAPPORT_JURISPRUDENCES.md`).
...
- Traiter les docs d'archive `📊_Rapports/🗄️_Archives/` et `STATUS.md` dans une passe dédiée (corriger les chemins morts ou marquer les sections comme historiques).
