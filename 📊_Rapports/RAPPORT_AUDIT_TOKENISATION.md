...
**Objet :** Audit des fuites de données personnelles dans [⚖️_Actes/🔑_Token](⚖️_Actes/🔑_Token/README.md)
...
|---|---|---|
| `05_🗂️_Organisation/22 📋 Modif Email Maire Foix.md` | 44 | `Sébastien GRAZIDE` |
| `05_🗂️_Organisation/22 📋 Modif Email Maire Foix.md` | 45 | `10 Avenue de Purpan, 31700 Blagnac` |
| `05_🗂️_Organisation/22 📋 Modif Email Maire Foix.md` | 46 | `sebastien.grazide@gmail.com` |
| `05_🗂️_Organisation/24 ✅ Checklist Envoi 11-07-2026.md` | 62 | `Sebastien GRAZIDE` |
| `05_🗂️_Organisation/24 ✅ Checklist Envoi 11-07-2026.md` | 69 | `Sebastien GRAZIDE` |
...
| Fichier | Ligne | Extrait |
|---|---|---|
| `03_📚_Analyses_juridiques/18 Note Audit RNE NPAI SAS.md` | 27 | `Sabir MOUNTASSER, né 1992, 108 Cité Aimé Surre, 09000 Foix` |
| `03_📚_Analyses_juridiques/18 Note Audit RNE NPAI SAS.md` | 28 | `Catherine SORROCHE/ANDISSAC, née 1970, 7 Rue Camille Mussat, 31100 Toulouse` |
...
| Fichier | Ligne | Extrait |
|---|---|---|
| `02_✉️_Courriers/34 ✉️ EMAIL Maire Foix - Police Municipale ERP.md` | 7 | `M. Bernard TAVELLA` |
| `02_✉️_Courriers/34 ✉️ EMAIL Maire Foix - Police Municipale ERP.md` | 13 | `btavella@mairie-foix.fr` |
| `02_✉️_Courriers/34 ✉️ EMAIL Maire Foix - Police Municipale ERP.md` | 14 | `secretariat@mairie-foix.fr` |
...
| Fichier | Ligne | Extrait |
|---|---|---|
| `05_🗂️_Organisation/21 📋 Plan Constat Police Foix.md` | 37 | `mairie@mairie-foix.fr` |

### 🔴 FUITE 5 — SIREN en clair (identifiant société)

| Fichier | Ligne | Extrait |
|---|---|---|
| `03_📚_Analyses_juridiques/18 Note Audit RNE NPAI SAS.md` | 23 | `938 033 222` |
| `02_✉️_Courriers/35 ✉️ Courrier President TJ Foix.md` | 94 | `(938 033 222)` |
| `02_✉️_Courriers/19 ✉️ Courrier FGTI.md` | 142 | `(938 033 222)` |
| `02_✉️_Courriers/14 ✉️ Courrier CODAF.md` | 102 | `(938 033 222)` |
| `02_✉️_Courriers/12 ✉️ Courrier URSSAF.md` | 99 | `(938 033 222)` |
...
| Fichier | Ligne | Extrait |
|---|---|---|
| `03_📚_Analyses_juridiques/18 Note Audit RNE NPAI SAS.md` | 25 | `22 Rue Lafaurie, 09000 Foix` |
| `03_📚_Analyses_juridiques/18 Note Audit RNE NPAI SAS.md` | 30 | `22 Rue Lafaurie` |
| `05_🗂️_Organisation/21 📋 Plan Constat Police Foix.md` | 40, 46 | `22 rue Lafaurie`, `22 Rue Lafaurie à Foix` |
| `05_🗂️_Organisation/22 📋 Modif Email Maire Foix.md` | 21, 25, 29 | `22 Rue Lafaurie` (3 occurrences) |

### 🔴 FUITE 7 — Nom de la SAS en clair

| Fichier | Ligne | Extrait |
|---|---|---|
| `05_🗂️_Organisation/21 📋 Plan Constat Police Foix.md` | 48 | `SAS LES MAUVAIS GARCONS` |
| `05_🗂️_Organisation/22 📋 Modif Email Maire Foix.md` | 29 | `SAS LES MAUVAIS GARCONS` |
| `05_🗂️_Organisation/24 ✅ Checklist Envoi 11-07-2026.md` | 31, 37 | `SAS LES MAUVAIS GARCONS` |

### 🟡 FUITE 8 — Nom médical en clair

| Fichier | Ligne | Extrait |
|---|---|---|
| `05_🗂️_Organisation/06 📋 Synthese des Actions et Audits.md` | 20 | `Dr DJERBI` |

### 🟡 FUITE 9 — Dates brutes non tokenisées

| Fichier | Ligne | Extrait |
|---|---|---|
| `01_⚖️_Actes_proceduraux/05 🎯 Conclusions Refere.md` | 42 | `29 mai 2026` |
| `01_⚖️_Actes_proceduraux/15 ⚖️ Réquisitoire introductif.md` | 40, 42 | `29 mai 2026`, `30 mai 2026` |
| `02_✉️_Courriers/31 ✉️ Courrier INPI Opposition.md` | 37 | `29 mai 2026` |
| `02_✉️_Courriers/33 ✉️ Requete Constat Huissier 145 CPC.md` | 55 | `30 mai 2026` |
| `02_✉️_Courriers/34 ✉️ EMAIL Maire Foix - Police Municipale ERP.md` | 22, 24 | `29 mai 2026`, `1er juin 2026` |
| `02_✉️_Courriers/35 ✉️ Courrier President TJ Foix.md` | 35 | `29 mai 2026` |
| `05_🗂️_Organisation/21 📋 Plan Constat Police Foix.md` | 46 | `29 mai 2026` |
| `05_🗂️_Organisation/22 📋 Modif Email Maire Foix.md` | 25 | `29 mai 2026` |
...
|---|---|---|
| `**[L'Adjoint au Maire de la Commune]**` | Monsieur TAVELLA | `02_✉️_Courriers/09`, `02_✉️_Courriers/08` |
| `**[L'Email de l'Adjoint au Maire]**` | *manquant* | `06_🗄️_Archives/🧠 STRATEGIE Contentieux Penal.md` |
| `**[Agent PJ, dépôt de plainte]**` | Jordy RODRIGUEZ CAPARROS | `01_⚖️_Actes_proceduraux/04`, `00_📂_Preuves_officielles/01` |
| `**[SMUR local]**` | SMUR 09 | `01_⚖️_Actes_proceduraux/01`, `01_⚖️_Actes_proceduraux/03`, `06_🗄️_Archives/📚 ANALYSE` |
| `**[Le Téléphone de la Victime]**` | 06 30 51 67 75 | *(défini dans script, non vérifié dans fichiers)* |
| `**[SIREN de l'Exploitation]**` | 938 033 222 | `02_✉️_Courriers/14, 12, 19, 35`, `01_⚖️_Actes/33` |
...
| `**[Adresse du Commerce]**` | 22 Rue Lafaurie, 09000 Foix | `02_✉️_Courriers/08` |
...
6. **`generate_real_versions.py` remplace les tokens `**[...]**`** par des valeurs réelles, mais il ignore les fichiers `INDEX.md` et `README.md` (ligne 147). Les fichiers dans `00_📂_Preuves_officielles/01` seront traités car ils ne s'appellent ni INDEX ni README, mais `batch_anonymize.py` ne pourrait pas retokenizer les fichiers 00.
...
2. **Régénérer ou corriger manuellement** les 3 fichiers les plus critiques :
   - `05_🗂️_Organisation/22 📋 Modif Email Maire Foix.md` — Remplacer `Sébastien GRAZIDE` par `**[La Victime]**`, l'adresse par `**[L'Adresse de la Victime]**`, l'email par `**[L'Email de la Victime]**`
   - `03_📚_Analyses_juridiques/18 Note Audit RNE NPAI SAS.md` — Tokeniser les noms complets, adresses personnelles, SIREN, dates de naissance des dirigeants
   - `02_✉️_Courriers/34 ✉️ EMAIL Maire Foix - Police Municipale ERP.md` — Remplacer `M. Bernard TAVELLA` par `**[L'Adjoint au Maire de la Commune]**`, les emails par `**[L'Email de l'Adjoint au Maire]**`
...
7. **Nettoyer `05_🗂️_Organisation/24 ✅ Checklist Envoi 11-07-2026.md`** — les lignes 62 et 69 contiennent `Sebastien GRAZIDE` en objet d'email.

8. **Nettoyer `05_🗂️_Organisation/21 📋 Plan Constat Police Foix.md`** — tokeniser le modèle d'email (adresse, nom SAS, date).
...
11. **Ajouter un test** d'intégrité qui vérifie qu'aucun fichier dans [⚖️_Actes/🔑_Token](⚖️_Actes/🔑_Token/README.md) ne contient de pattern PII (email, téléphone, SIREN, etc.).
