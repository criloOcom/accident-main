...
**Référence** : `📊_Rapports/RAPPORT_AUDIT_HERMES_20260711.md`
...
### P0-2 — `⚖️_Actes/README.md` : dossiers renommés  [SCRIPT]
...
- **Cibles** :
  - `⚖️_Actes/🔑_Token/03_📚_Analyses_juridiques/13 📜 Responsabilites legales.md` (L92-98, 4 liens `../../../📜_Lois/X.md`)
  - `⚖️_Actes/🔑_Token/03_📚_Analyses_juridiques/14 Stratégie jurisprudentielle.md` (L30-37, ~11 liens `../../📜_Lois/X.md`)
...
- **Vérifier** cible existe : `📜_Lois/📜_Jurisprudence/89-18.422_CourCassation.md` ✅ présent.
...
- **Correction** : préfixer `📎_Annexes/` → `📎_Annexes/ANNEXE_1_Decision_CC_CIV1_1965-04-30.md` (les 3 annexes sont dans `⚖️_Actes/📎_Annexes/`).
...
- **Cibles** (~15) : tous les `⚖️_Actes/00_Preuves_officielles/{date}*/README.md`, `⚖️_Actes/🔑_Token/06_🗄️_Archives/annexes/README.md`, `⚖️_Actes/📎_Annexes/README.md`, `.dev/jules_recommandations/README.md`.
...
- **Cibles** : 20 README de sous-dossiers (`⚖️_Actes/00_Preuves_officielles/{date}*/README.md` L7 : `🔙 [📁 ...](../README.md)`) + `📊_Rapports/RAPPORT_NAVIGATION_INTERACTIVE_20260711.md` L78 (`Retour à l'accueil`).
...
- **Action** : archiver dans `📊_Rapports/🗄️_Archives/` ou supprimer (après confirmation qu'il ne sert plus). Génère 45 liens fantômes.
...
- **Correction** : créer `⚖️_Actes/00_Preuves_officielles/README.md` (frontmatter `type: readme`) listant les 13 sous-dossiers.
...
- **Action** : relier depuis un index (`📊_Rapports/README.md`) ou archiver dans `📊_Rapports/🗄️_Archives/`.
...
- **Cible** : `⚖️_Actes/👤_Reel/00_📂_Preuves_officielles/README.md` (3 lignes).
