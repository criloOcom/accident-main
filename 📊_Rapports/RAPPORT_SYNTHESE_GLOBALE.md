...
1. **Imprimer + envoyer les 4 LRAR Vague 1** (URSSAF, CODAF, FGTI, Président TJ) — checklist fichier 24
2. **Copier-coller l'email Maire Foix** dans Gmail manuellement (OAuth bloqué)
3. **Noter les N° LRAR** sur la checklist → reporter dans fichier 23
...
### Documentaire
- **Tenir à jour le fichier 23 (Suivi LRAR)** après chaque envoi — le tableau de bord est l'outil de pilotage
