...
Cette note présente une estimation indicative des frais de justice (débours, émoluments et honoraires) liés à l'intervention de l'huissier de justice (commissaire de justice) pour le constat des lieux et autres actes accessoires dans le dossier opposant **[La Victime]** à **[L'Exploitant du Commerce (La SAS)]**.

L'estimation prend en compte le recours potentiel à des tiers (serrurier, force publique, professionnel spécialisé).

---

## 1. DÉTAIL ESTIMATIF DES INTERVENTIONS

### A. Constat des lieux (Article 145 CPC)
...
### B. Sommation interpellative (Témoignages / Déclarations)
...
### C. Frais annexes (Sur ordonnance si refus d'accès)
...
*Nota Bene :* Conformément à l'Article 700 du Code de procédure civile et à la demande des dépens dans l'assignation référé (Pièce 16), ces frais de constat et d'huissier, indispensables pour sauvegarder la preuve, pourront être mis à la charge définitive de la partie adverse par le juge.
