...
**Périmètre** : tous les `.md` hors `.git/`, `.pytest_cache/`, `.venv/`, `node_modules/`, `.opencode/`, et hors `📊_Rapports/🗄️_Archives/`
...
- 🟡 **~1095 références à des fichiers `.md` en texte brut** (non liées) détectées hors des balises markdown. Répartition : `README.md` (67), fichiers mémoire/rapports/actes token. Exemples :
  ...
  - `⚖️_Actes/🔑_Token/README.md` L22 : `MAP.md`, `VARIABLES.md` en texte brut.
...
- 🔴 **~15 `README.md` de sous-dossiers sans AUCUN frontmatter** (après breadcrumb, le fichier démarre par `# Titre`). Exemples confirmés :
  - `⚖️_Actes/00_Preuves_officielles/20260529 🩹 DrJARDON/README.md`
  - `⚖️_Actes/00_Preuves_officielles/20260708 ✉️ LR Relance ASSURANCE/README.md`
  - `⚖️_Actes/🔑_Token/06_🗄️_Archives/annexes/README.md`
...
- 🔴 **8 fichiers `statut: final` contenant encore des placeholders** (non résolus par la rétrogradation) :
  ...
  - `⚖️_Actes/🔑_Token/01_⚖️_Actes_proceduraux/02b 🛡️ Constitution Partie Civile.md` → `[...]`
  - `⚖️_Actes/🔑_Token/02_✉️_Courriers/31 ✉️ Courrier INPI Opposition.md` → `[...]`
  - `⚖️_Actes/🔑_Token/04_💰_Etudes_indemnisation/11+12 📊 Evaluation Dintilhac consolidee.md` → `[...]`
...
- 🔴 **`🔙` (retour) présent dans 20 README de sous-dossiers** (ex. `⚖️_Actes/00_Preuves_officielles/20260529 🩹 DrJARDON/README.md` L7 : `🔙 [📁 00_Preuves_officielles](../README.md)`). Pattern de navigation interdit non supprimé lors du nettoyage.
- 🔴 **1 « Retour à l'accueil »** : `📊_Rapports/RAPPORT_NAVIGATION_INTERACTIVE_20260711.md` L78 — pattern interdit.
...
- 🟡 **13 sous-dossiers de `00_Preuves_officielles/` sans `README.md` parent** : `⚖️_Actes/00_Preuves_officielles/README.md` n'existe pas, or chaque sous-dossier `…/README.md` pointe vers `../README.md` (parent absent) → 13 liens cassés.
...
| `⚖️_Actes/README.md` | 9 | Pointe vers `token/` et `reel/` (renommés `🔑_Token`/`👤_Reel`) |
| `STATUS.md`, `DESIGN.md`, `VACCIN.md`, `DECISIONS.md`, rapport doc | 12 | Divers |

**Vrais bugs de liens (indépendants des fichiers fantômes) :**
- 🔴 `⚖️_Actes/README.md` L21-40 : `token/README.md`, `reel/README.md`, `token/0X_…/README.md` → dossiers renommés `🔑_Token`/`👤_Reel` non propagés.
- 🔴 `13 📜 Responsabilites legales.md` L92-98 et `14 Stratégie jurisprudentielle.md` : `../../../📜_Lois/89-18.422_CourCassation.md` → le fichier réel est `📜_Lois/📜_Jurisprudence/89-18.422_CourCassation.md` (sous-dossier omis).
- 🔴 `01 ⚖️ Assignation.md` L106-126, 347-349 : `ANNEXE_1_Decision_CC_CIV1_1965-04-30.md` / `📎_Annexes/ANNEXE_…md` → les annexes sont dans `⚖️_Actes/📎_Annexes/` (chemin relatif faux).
...
- ⚪ **1 fichier quasi-vide** : `⚖️_Actes/👤_Reel/00_📂_Preuves_officielles/README.md` (3 lignes de contenu). À compléter ou supprimer.
...
2. Corriger `⚖️_Actes/README.md` L21-40 : remplacer `token/`→`🔑_Token/`, `reel/`→`👤_Reel/` (9 liens).
...
**P2 — Structure**
11. Créer `⚖️_Actes/00_Preuves_officielles/README.md` (parent manquant pour 13 sous-dossiers).
...
16. Compléter ou supprimer `⚖️_Actes/👤_Reel/00_📂_Preuves_officielles/README.md` (3 lignes).
