...
**Périmètre** : tous les `.md` hors `.git/`, `.pytest_cache/`, `.venv/`, `node_modules/`, `.opencode/`, et hors [📊_Rapports/🗄️_Archives](📊_Rapports/🗄️_Archives/README.md)
...
- 🟡 **~1095 références à des fichiers `.md` en texte brut** (non liées) détectées hors des balises markdown. Répartition : `README.md` (67), fichiers mémoire/rapports/actes token. Exemples :
  ...
  - [⚖️_Actes/🔑_Token/README.md](⚖️_Actes/🔑_Token/README.md) L22 : `MAP.md`, `VARIABLES.md` en texte brut.
...
- 🔴 **~15 `README.md` de sous-dossiers sans AUCUN frontmatter** (après breadcrumb, le fichier démarre par `# Titre`). Exemples confirmés :
  - [⚖️_Actes/00_Preuves_officielles/20260529 🩹 DrJARDON/README.md](⚖️_Actes/00_Preuves_officielles/20260529 🩹 DrJARDON/README.md)
  - [⚖️_Actes/00_Preuves_officielles/20260708 ✉️ LR Relance ASSURANCE/README.md](⚖️_Actes/00_Preuves_officielles/20260708 ✉️ LR Relance ASSURANCE/README.md)
  - [⚖️_Actes/🔑_Token/06_🗄️_Archives/annexes/README.md](⚖️_Actes/🔑_Token/06_🗄️_Archives/annexes/README.md)
  - `.dev/jules_recommandations/README.md`
  - (14 occurrences au total dans `00_Preuves_officielles/*`)
...
- 🔴 **8 fichiers `statut: final` contenant encore des placeholders** (non résolus par la rétrogradation) :
  ...
  - (et les 4 versions `👤_Reel/` correspondantes)
  - → Ces fichiers portent `final` mais gardent `[...]` dans le corps : incohérence avec RULES #15.

### Catégorie 4 — Structure & navigation
**Score : 10 / 20**

- 🔴 **Dossier `🚦 Status/` EXISTE** (avec `01_PREPARATION.md`, `02_PRET_POUR_ENVOI.md`, `03_ENVOYE.md`) — corrigendum : l'audit initial indiquait à tort « inexistant ». Le vrai défaut : ses 3 index utilisent des **chemins absolus** `/⚖️_Actes/...` au lieu de chemins relatifs `../⚖️_Actes/...`. Résultat : 164 liens morts (voir Cat 5). `README.md` L25 pointe correctement vers `./🚦_Status/README.md`.
- 🔴 **`README_OLD.md` interdit présent** : `📜_Lois/README_OLD.md` (62 lignes). Les règles interdisent les fichiers orphelins/obsolètes à la racine ; un `README_OLD` est un résidu à archiver ou supprimer. (Il génère 45 liens cassés fantômes.)
- 🔴 **`🔙` (retour) présent dans 20 README de sous-dossiers** (ex. [⚖️_Actes/00_Preuves_officielles/20260529 🩹 DrJARDON/README.md](⚖️_Actes/00_Preuves_officielles/20260529 🩹 DrJARDON/README.md) L7 : `🔙 [📁 00_Preuves_officielles](../README.md)`). Pattern de navigation interdit non supprimé lors du nettoyage.
- 🔴 **1 « Retour à l'accueil »** : [📊_Rapports/RAPPORT_NAVIGATION_INTERACTIVE_20260711.md](📊_Rapports/RAPPORT_NAVIGATION_INTERACTIVE_20260711.md) L78 — pattern interdit.
...
- 🟡 **13 sous-dossiers de `00_Preuves_officielles/` sans `README.md` parent** : [⚖️_Actes/00_Preuves_officielles/README.md](⚖️_Actes/00_Preuves_officielles/README.md) n'existe pas, or chaque sous-dossier `…/README.md` pointe vers `../README.md` (parent absent) → 13 liens cassés.
...
| Source | Nb | Nature |
|---|---|---|
| `01_PREPARATION.md` / `02_PRET_POUR_ENVOI.md` / `03_ENVOYE.md` | 164 | Chemins absolus `/⚖️_Actes/...` au lieu de `../⚖️_Actes/...` (dossier `🚦 Status/` existe bien) |
| `README.md` (racine) | 52 | Liens vers fichiers déplacés/renommés |
| `14 Stratégie jurisprudentielle.md` | 22 | Liens jurisprudence omettant `📜_Jurisprudence/` |
| `01 ⚖️ Assignation.md` | 12 | Annexes référencées sans chemin correct (`ANNEXE_1_…md` au lieu de `📎_Annexes/ANNEXE_1_…md`) |
| `📜_Lois/README_OLD.md` | 45 | Fichier obsolète |
| `RAPPORT_NAVIGATION_INTERACTIVE_20260711.md` | 13 | Rapport |
| `13 📜 Responsabilites legales.md` | 8 | Liens jurisprudence omettant `📜_Jurisprudence/` |
| [⚖️_Actes/README.md](⚖️_Actes/README.md) | 9 | Pointe vers `token/` et `reel/` (renommés `🔑_Token`/`👤_Reel`) |
| `STATUS.md`, `DESIGN.md`, `VACCIN.md`, `DECISIONS.md`, rapport doc | 12 | Divers |

**Vrais bugs de liens (indépendants des fichiers fantômes) :**
- 🔴 [⚖️_Actes/README.md](⚖️_Actes/README.md) L21-40 : `token/README.md`, `reel/README.md`, `token/0X_…/README.md` → dossiers renommés `🔑_Token`/`👤_Reel` non propagés.
- 🔴 `13 📜 Responsabilites legales.md` L92-98 et `14 Stratégie jurisprudentielle.md` : `../../../📜_Lois/89-18.422_CourCassation.md` → le fichier réel est [📜_Lois/📜_Jurisprudence/89-18.422_CourCassation.md](📜_Lois/📜_Jurisprudence/89-18.422_CourCassation.md) (sous-dossier omis).
- 🔴 `01 ⚖️ Assignation.md` L106-126, 347-349 : `ANNEXE_1_Decision_CC_CIV1_1965-04-30.md` / `📎_Annexes/ANNEXE_…md` → les annexes sont dans [⚖️_Actes/📎_Annexes](⚖️_Actes/📎_Annexes/README.md) (chemin relatif faux).
...
- 🟡 **37 fichiers « orphelins »** (non référencés par nom dans aucun autre `.md`) — majoritairement des **rapports d'audit du 11-07** (`RAPPORT_AUDIT_*.md`, `RAPPORT_CORRECTION_*.md`, `RAPPORT_*.md` de méthodologie) + [🧠_Memory/JULES_MCP_GUIDELINES.md](🧠_Memory/JULES_MCP_GUIDELINES.md), `NOTE_SYNTHESE_AVOCAT.md`, `RECADRAGE_NOMENCLATURE.md`, `JUSTIFICATION_PROVISION_15000.md`. La plupart sont des rapports de bord — utiles mais non reliés entre eux. À relier depuis un index ou à archiver.
...
- ⚪ **1 fichier quasi-vide** : [⚖️_Actes/👤_Reel/00_📂_Preuves_officielles/README.md](⚖️_Actes/👤_Reel/00_📂_Preuves_officielles/README.md) (3 lignes de contenu). À compléter ou supprimer.
...
1. **Dossier `🚦 Status/` existe** — corriger ses 3 index (`01_PREPARATION.md`, `02_PRET_POUR_ENVOI.md`, `03_ENVOYE.md`) : remplacer tous les liens absolus `/⚖️_Actes/...` par des chemins relatifs `../⚖️_Actes/...`. (164 liens dépendent de ça.)
2. Corriger [⚖️_Actes/README.md](⚖️_Actes/README.md) L21-40 : remplacer `token/`→`🔑_Token/`, `reel/`→`👤_Reel/` (9 liens).
3. Corriger les liens jurisprudence (`13 Responsabilites`, `14 Stratégie`) : ajouter le sous-dossier `📜_Jurisprudence/` (≈30 liens).
4. Corriger `01 ⚖️ Assignation.md` : préfixer `📎_Annexes/` aux liens d'annexe (L106-126, 347-349).
...
10. Supprimer ou archiver `📜_Lois/README_OLD.md`.

**P2 — Structure**
11. Créer [⚖️_Actes/00_Preuves_officielles/README.md](⚖️_Actes/00_Preuves_officielles/README.md) (parent manquant pour 13 sous-dossiers).
...
16. Compléter ou supprimer [⚖️_Actes/👤_Reel/00_📂_Preuves_officielles/README.md](⚖️_Actes/👤_Reel/00_📂_Preuves_officielles/README.md) (3 lignes).
