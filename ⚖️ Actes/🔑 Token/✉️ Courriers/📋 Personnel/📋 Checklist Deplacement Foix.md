...
<!-- Breadcrumb -->
*[🏠](../../../../README.md) › [📁 Actes](../../../README.md) › [🎭 Token](../../README.md) › [✉️ Courriers](../README.md) › [📋 Personnel](./README.md) › 📋 Checklist Deplacement Foix*
<hr>
<!-- /Breadcrumb -->
...
| **Midi** (12h-14h) | [**[L'Adresse de l'Exploitation]**](../../../../%F0%9F%A7%A0%20Memory/%F0%9F%97%82%EF%B8%8F%20Tokens/token-exploitation-adresse.md) | Visite des lieux : photos + constat personnel |
...
- [**[L'Adresse de l'Exploitation]**](../../../../%F0%9F%A7%A0%20Memory/%F0%9F%97%82%EF%B8%8F%20Tokens/token-exploitation-adresse.md) : Lieu de l'accident — salon "[**[L'Exploitant du Commerce (La SAS)]**](../../../../%F0%9F%A7%A0%20Memory/%F0%9F%97%82%EF%B8%8F%20Tokens/token-exploitation-raison-sociale.md)"
<hr><hr>
...
- [ ] Carte vitale + attestation droits

- [ ] RIB (au cas où)

**💾 Support numérique :**
- [ ] Clé USB avec tous les documents

- [ ] Dossier cloud accessible (Google Drive/Dropbox)

- [ ] Sauvegarde sur téléphone
...
- [ ] Carnet de notes (format A5)

- [ ] Surligneur (jaune)

- [ ] Trombones et élastiques
...
- [ ] Vérifier la météo finale

- [ ] Recharger téléphone + batterie externe à 100 %

- [ ] Vérifier les documents une dernière fois

- [ ] Préparer un sac à dos/serviette avec 3 pochettes séparées

- [ ] Vérifier les transports (essence/transports en commun)
...
- [ ] Formulaire AJ + pièces justificatives

- [ ] PV initial + certificats médicaux + Kbis
...
- [ ] Attestations sur l'honneur vierges
...
- [ ] Plainte complémentaire n°36 × 2 exemplaires

- [ ] PV initial + certificats médicaux + Kbis

- [ ] LRAR NPAI + accusés réception

- [ ] Chronologie démarches
...
**🍎 Confort :**
- [ ] Bouteille d'eau (50cl)

- [ ] Barre de céréales/encas
...
- [ ] Demander la direction du **greffe civil**

- [ ] Demander la direction du **BAJ (Bureau d'Aide Juridictionnelle)**
...
- [ ] Remettre les **pièces jointes** (PV, certificats médicaux, Kbis, photos)
...
- [ ] **OBTENIR : un récépissé de dépôt** avec numéro de dossier — GARDER PRÉCIEUSEMENT
...
- [ ] Remettre avis d'imposition + justificatifs revenus

- [ ] Remettre pièce d'identité + justificatif domicile
...
## VI — 🏛️ ÉTAPE 2 — VISITE DES LIEUX (Midi, [**[L'Adresse de l'Exploitation]**](../../../../%F0%9F%A7%A0%20Memory/%F0%9F%97%82%EF%B8%8F%20Tokens/token-exploitation-adresse.md))

### VI.1 — Sur place

- [ ] Prendre **photos de la devanture** (plan large + plan serré)

- [ ] Prendre **photos de l'enseigne** (nom actuel, nouvelle éventuelle)

- [ ] Regarder à l'intérieur par les vitrines : état du salon, emplacement vasque

- [ ] **Repérer les caméras de surveillance** visibles (extérieur/intérieur)

- [ ] Regarder les commerces voisins : y a-t-il des caméras qui filment la rue ?

- [ ] Chercher toute **nouvelle occupation** des locaux
...
- [ ] Rédiger **sur place** un constat daté et signé :
  ...
  - Constatations visuelles (fermé, abandonné, rouvert, etc.)

  - État de la devanture, de l'enseigne

  - Caméras repérées (position, orientation)

  - Témoins éventuels rencontrés
...
- [ ] Demander à parler au service des plaintes

- [ ] Noter le nom de la personne à l'accueil

- [ ] Demander un ticket ou numéro d'attente
...
- [ ] **Entrave à la constatation d'une infraction** (art. 434-15 CP) — refus de communiquer l'assurance RC

- [ ] **Défaut d'assurance RC professionnelle** (art. L.324-2 C.assur.) — infraction pénale autonome

- [ ] **Abandon de fonds de commerce** (art. L.141-1 C.com.) — si indices de cessation non déclarée

**✅ Demandes spécifiques :**
- [ ] Saisie et conservation des vidéosurveillance (art. 56 CPP)

- [ ] Transmission au Parquet de Foix

- [ ] Désignation d'un OPJ référent pour le suivi

- [ ] Copie du nouveau PV

**✅ Questions à poser :**
- [ ] Numéro du nouveau PV de plainte ? (demander qu'il référence le PV 2026/015967)

- [ ] Nom de l'officier référent pour le suivi ?
...
|-------------------|---------------|
| "Vous avez déjà porté plainte à Toulouse" | "Exact, c'est une **plainte complémentaire** pour des faits nouveaux découverts depuis : obstruction, abandon du fonds, défaut d'assurance" |
...
- [ ] Nom et coordonnées de l'officier référent

- [ ] Récépissé de dépôt ou copie du PV (si possible)
...
- [ ] Toutes les réponses ont été notées

- [ ] Prochaines étapes sont claires

- [ ] **Récépissés obtenus** (TJ + AJ + Commissariat)
...
- [ ] Scanner les récépissés (TJ, AJ, commissariat)

- [ ] Télécharger/classer les photos de la visite
...
- [ ] Résumer les engagements pris

- [ ] Mettre à jour STATUS.md et TODO.md
...
- [ ] Vérifier le suivi AJ (numéro dossier)

- [ ] Relancer si aucun accusé de réception
...
**J+3 :**
- [ ] Premier contact avec l'officier référent

- [ ] Demande d'avancement

- [ ] Préparation relance si nécessaire

**J+7 :**
- [ ] Vérification enquête ouverte

- [ ] Demande rapport d'enquête

- [ ] Relance Procureur si nécessaire
...
- Soyez précis sur les dates et faits
...
- Obtenez des copies de tous documents
...
- Classez les documents reçus

- Mettez à jour vos dossiers

- Envoyez un email de suivi

- Préparez la prochaine étape

- Informez votre avocat si vous en avez un

❌ **À éviter :**
- Ne laissez pas traîner les documents
...
- [ ] Dossier physique organisé

- [ ] Support numérique prêt
...
**💪 BON COURAGE !** Vous êtes bien préparé(e) avec un dossier solide et des preuves tangibles. Présentez votre affaire avec confiance et professionnalisme. Les services de police sont là pour vous aider - donnez-leur tous les éléments nécessaires pour agir efficacement.