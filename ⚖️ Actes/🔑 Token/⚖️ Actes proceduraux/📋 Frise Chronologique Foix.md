...
auteur: La Victime
reel_path: ../../👤 Reel/⚖️ Actes proceduraux/📋 Frise Chronologique Foix.md
---

<!-- Breadcrumb -->
*[🏠](../../../README.md) › **[📁 Actes]**(../../README.md) › **[🎭 Token]**(../README.md) › **[⚖️ Actes Procéduraux]**(./README.md) › 📋 Frise Chronologique [La Ville de l'Accident]*
<hr>
<!-- /Breadcrumb -->

# FRISE CHRONOLOGIQUE SIMPLIFIÉE
## Dossier **[La Victime]** — Accident du 29 mai 2026

| Date | Événement | Observation rapide |
|:----:|-----------|-------------------|
| **10/03/2026** | Fin d'activité de la **[L'Exploitant du Commerce (La SAS)]** dans les locaux du 22 rue Lafaurie (version bailleur) | État des lieux de sortie signé par **[Le Président de l'Exploitation]** (pièces jointes mail DELRIEU) |
| **22/04/2026** | Création de la **SAS [Le Nouvel Exploitant (HB BARBER)]** (SIREN **[SIREN du Nouvel Exploitant]**) au 22 Grande Rue La Faurie, **[La Ville de l'Accident]** | Même adresse, même activité (coiffure/barbier), DG commune : **[La Directrice Générale de l'Exploitation]** |
