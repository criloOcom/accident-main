...
Rédigé par : [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md)
...
## INTRODUCTION
La présente synthèse juridique et FAQ a été rédigée par [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md) dans le cadre du contentieux l'opposant à [**[L'Exploitant du Commerce (La SAS)]**](../../../🧠 Memory/🗂️ Jetons/token-l-exploitant-du-commerce-la-sas.md) à la suite de l'accident corporel du [**[J+0 Accident]**](../../../🧠 Memory/🗂️ Jetons/token-j-0-accident.md).
...
Cette synthèse a pour objet de récapituler les éléments factuels et juridiques relatifs à l'accident corporel survenu le [**[J+0 Accident]**](../../../🧠 Memory/🗂️ Jetons/token-j-0-accident.md) à 15h00 au sein du salon de coiffure exploité par [**[L'Exploitant du Commerce (La SAS)]**](../../../🧠 Memory/🗂️ Jetons/token-l-exploitant-du-commerce-la-sas.md), situé au [**[L'Adresse de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-l-adresse-de-l-exploitation.md) à [**[La Ville de l'Accident]**](../../../🧠 Memory/🗂️ Jetons/token-la-ville-de-l-accident.md).

La victime, [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md), né le 18/01/1982, exerce la profession d'informaticien indépendant ([**[L'Identifiant Professionnel de la Victime]**](../../../🧠 Memory/🗂️ Jetons/token-l-identifiant-professionnel-de-la-victime.md)) à [**[La Ville de Résidence de la Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-ville-de-residence-de-la-victime.md).

Les parties mises en cause incluent la SAS elle-même, ses dirigeants [**[Le Président de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-le-president-de-l-exploitation.md) et [**[La Directrice Générale de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-la-directrice-generale-de-l-exploitation.md), ainsi que [**[Le Propriétaire des Murs]**](../../../🧠 Memory/🗂️ Jetons/token-le-proprietaire-des-murs.md), propriétaire des murs commerciaux.

<hr>

## II. FOIRE AUX QUESTIONS (FAQ) DÉTAILLÉE
### Q : DANS QUELLES CIRCONSTANCES L'ACCIDENT S'EST-IL PRODUIT ?
Le jour de l'accident, [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md) est revenu au salon pour une simple retouche. Un employé de l'établissement est alors monté sur un bac à shampoing en céramique qui s'est déséquilibré. Par réflexe, [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md) a tendu la main droite pour protéger [**[Le Préposé de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-le-prepose-de-l-exploitation.md) et stabiliser le meuble.
...
Malgré une intervention de microchirurgie réalisée le [**[J+1 Chirurgie]**](../../../🧠 Memory/🗂️ Jetons/token-j-1-chirurgie.md) à la [**[L'Établissement SOS Main]**](../../../🧠 Memory/🗂️ Jetons/token-l-etablissement-sos-main.md) par le [**[Le Chirurgien SOS Main]**](../../../🧠 Memory/🗂️ Jetons/token-le-chirurgien-sos-main.md), la victime souffre à ce jour d'une insensibilité totale de l'index et d'un blocage mécanique de la flexion. Son activité d'informaticien est gravement compromise, justifiant une ITT initiale de 56 jours.
...
Sur le plan civil, plusieurs mises en demeure ont été expédiées le [**[J+31 Mises en demeure]**](../../../🧠 Memory/🗂️ Jetons/token-j-31-mises-en-demeure.md) pour identifier l'assureur et solliciter une provision :

- Courrier à l'attention du Président [**[Le Président de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-le-president-de-l-exploitation.md) ;

- Courrier à la Directrice Générale [**[La Directrice Générale de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-la-directrice-generale-de-l-exploitation.md) ;
...
Une étape cruciale est fixée au [**[J+167 Expertise UMJ]**](../../../🧠 Memory/🗂️ Jetons/token-j-167-expertise-umj.md) pour l'expertise médicale à l'UMJ de [**[La Métropole Régionale]**](../../../🧠 Memory/🗂️ Jetons/token-la-metropole-regionale.md), qui permettra de chiffrer définitivement les préjudices (actuellement estimés à **~90 000 €**).
...
*Synthèse établie pour servir et valoir ce que de droit. © [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md).*

*Q15 : Que se passe-t-il si [**[L'Exploitant du Commerce (La SAS)]**](../../../🧠 Memory/🗂️ Jetons/token-l-exploitant-du-commerce-la-sas.md) est mise en liquidation ou radiée pendant la procédure ?*
