...
**PARTIES AU LITIGE :**
- **Demandeur :** [**[La Victime]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques), informaticien indépendant
...
**ÉVÉNEMENT :** Accident corporel grave survenu le [**[J+0 Accident]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#tokens-evenementiels). Basculement d'un équipement défectueux causant une section nerveuse et tendineuse à la main droite de [**[La Victime]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques).
...
- **Pièce ACQ-10 :** Procès-verbal de constat de police confirmant les circonstances matérielles ([**[J+4 Dépôt de plainte]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#tokens-evenementiels))
- **Pièce ACQ-09 :** Dépôt de plainte officiel formalisant l'infraction pénale ([**[J+3 Premiers arrêts]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#tokens-evenementiels))
...
- **Pièce ACQ-17 :** Mises en demeure par Lettres Recommandées avec Accusé de Réception ([**[J+31 Mises en demeure]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#tokens-evenementiels))
...
- **[J+0 Accident] :** Date de l'accident au sein de l'établissement [**[L'Exploitant du Commerce (La SAS)]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-morales). Le préposé [**[Le Préposé de l'Exploitation]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques) monte sur la vasque du bac à shampoing qui bascule. En tentant de le protéger par réflexe, [**[La Victime]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques) heurte une cassure tranchante préexistante de la vasque. Section des tendons et nerfs de l'index droit.
- **[J+1 Chirurgie] :** Intervention en urgence de microchirurgie à la [**[L'Établissement SOS Main]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-morales) par [**[Le Chirurgien SOS Main]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques).
...
- **La garde :** [**[L'Exploitant du Commerce (La SAS)]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-morales) est le propriétaire et l'exploitant du matériel défectueux.
- **Absence d'exonération :** La réaction réflexe de sauvegarde de [**[La Victime]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques) pour éviter la chute du préposé ne constitue en aucun cas une faute. Il n'y a pas non plus de force majeure invocable.
...
La responsabilité de [**[Le Président de l'Exploitation]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques) et [**[La Directrice Générale de l'Exploitation]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques) est directement engagée :
...
- **Immunité du préposé (Arrêt Costedoat - Ass. Plén., 25 février 2000) :** [N° 97-17.378](https://www.legifrance.gouv.fr/juri/id/JURITEXT000007043704). Le préposé [**[Le Préposé de l'Exploitation]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques) ayant agi dans le cadre de ses fonctions, il bénéficie d'une immunité civile de principe. Seul l'employeur (le commettant) engage sa responsabilité.
...
- **Principe de réparation intégrale (Art. 1240 C. civ.) :** La victime doit être replacée dans la situation qui était la sienne avant le dommage, sans perte ni profit. Pour [**[La Victime]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-physiques), informaticien indépendant, l'incidence professionnelle est majeure.
...
**Q2 : "Avez-vous l'attestation d'assurance de la société [**[L'Exploitant du Commerce (La SAS)]**](%F0%9F%A7%A0%20Memory/TOKEN%20MAP.md#personnes-morales) ?"** <br>
