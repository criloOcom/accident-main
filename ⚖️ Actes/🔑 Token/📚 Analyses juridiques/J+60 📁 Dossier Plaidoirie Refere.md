...
**PARTIES AU LITIGE :**
- **Demandeur :** [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md), informaticien indépendant
- **Défendeurs :** [**[L'Exploitant du Commerce (La SAS)]**](../../../🧠 Memory/🗂️ Jetons/token-l-exploitant-du-commerce-la-sas.md), ainsi que ses dirigeants [**[Le Président de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-le-president-de-l-exploitation.md) et [**[La Directrice Générale de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-la-directrice-generale-de-l-exploitation.md)
...
**ÉVÉNEMENT :** Accident corporel grave survenu le [**[J+0 Accident]**](../../../🧠 Memory/🗂️ Jetons/token-j-0-accident.md). Basculement d'un équipement défectueux causant une section nerveuse et tendineuse à la main droite de [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md).
...
- **Pièce ACQ-10 :** Procès-verbal de constat de police confirmant les circonstances matérielles ([**[J+4 Dépôt de plainte]**](../../../🧠 Memory/🗂️ Jetons/token-j-4-depot-de-plainte.md))
- **Pièce ACQ-09 :** Dépôt de plainte officiel formalisant l'infraction pénale ([**[J+3 Premiers arrêts]**](../../../🧠 Memory/🗂️ Jetons/token-j-3-premiers-arrets.md))
- **Pièce ACQ-04 :** [Compte-rendu opératoire](%E2%9A%96%EF%B8%8F%20Actes/Preuves%20officielles/20260530%20%F0%9F%86%98%20SOSMain/20260530%20CR%20Op%C3%A9ratoire%20RapportInterventionMainDroite.md) attestant de la section tendineuse et nerveuse ([**[J+1 Chirurgie]**](../../../🧠 Memory/🗂️ Jetons/token-j-1-chirurgie.md))
- **Pièce ACQ-17 :** Mises en demeure par Lettres Recommandées avec Accusé de Réception ([**[J+31 Mises en demeure]**](../../../🧠 Memory/🗂️ Jetons/token-j-31-mises-en-demeure.md))
...
- **[J+0 Accident] :** Date de l'accident au sein de l'établissement [**[L'Exploitant du Commerce (La SAS)]**](../../../🧠 Memory/🗂️ Jetons/token-l-exploitant-du-commerce-la-sas.md). Le préposé [**[Le Préposé de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-le-prepose-de-l-exploitation.md) monte sur la vasque du bac à shampoing qui bascule. En tentant de le protéger par réflexe, [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md) heurte une cassure tranchante préexistante de la vasque. Section des tendons et nerfs de l'index droit.
- **[J+1 Chirurgie] :** Intervention en urgence de microchirurgie à la [**[L'Établissement SOS Main]**](../../../🧠 Memory/🗂️ Jetons/token-l-etablissement-sos-main.md) par [**[Le Chirurgien SOS Main]**](../../../🧠 Memory/🗂️ Jetons/token-le-chirurgien-sos-main.md).
...
- **La garde :** [**[L'Exploitant du Commerce (La SAS)]**](../../../🧠 Memory/🗂️ Jetons/token-l-exploitant-du-commerce-la-sas.md) est le propriétaire et l'exploitant du matériel défectueux.
- **Absence d'exonération :** La réaction réflexe de sauvegarde de [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md) pour éviter la chute du préposé ne constitue en aucun cas une faute. Il n'y a pas non plus de force majeure invocable.
...
La responsabilité de [**[Le Président de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-le-president-de-l-exploitation.md) et [**[La Directrice Générale de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-la-directrice-generale-de-l-exploitation.md) est directement engagée :
...
- **Immunité du préposé (Arrêt Costedoat - Ass. Plén., 25 février 2000) :** [N° 97-17.378](https://www.legifrance.gouv.fr/juri/id/JURITEXT000007043704). Le préposé [**[Le Préposé de l'Exploitation]**](../../../🧠 Memory/🗂️ Jetons/token-le-prepose-de-l-exploitation.md) ayant agi dans le cadre de ses fonctions, il bénéficie d'une immunité civile de principe. Seul l'employeur (le commettant) engage sa responsabilité.
...
- **Principe de réparation intégrale (Art. 1240 C. civ.) :** La victime doit être replacée dans la situation qui était la sienne avant le dommage, sans perte ni profit. Pour [**[La Victime]**](../../../🧠 Memory/🗂️ Jetons/token-la-victime.md), informaticien indépendant, l'incidence professionnelle est majeure.
...
- **Pièce ACQ-04** ([Compte-rendu opératoire](%E2%9A%96%EF%B8%8F%20Actes/Preuves%20officielles/20260530%20%F0%9F%86%98%20SOSMain/20260530%20CR%20Op%C3%A9ratoire%20RapportInterventionMainDroite.md)) de [**[Le Chirurgien SOS Main]**](../../../🧠 Memory/🗂️ Jetons/token-le-chirurgien-sos-main.md) pour mesurer la gravité médicale de l'atteinte tendineuse et nerveuse.
