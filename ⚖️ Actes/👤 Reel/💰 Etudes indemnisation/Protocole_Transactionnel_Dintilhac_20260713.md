...
1. **M. [La Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-nom-complet.md)**, né le [Date de Naissance de la Victime](../../../🧠%20Memory/STRICT%20VARIABLES.md), demeurant au [Adresse de la Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-adresse.md),
   Assisté de **Me [L'Avocat de la Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-avocat-nom.md)**, Avocat au Barreau de [Barreau Avocat Victime](../../../🧠%20Memory/STRICT%20VARIABLES.md),
...
2. **La société [L'Exploitant](../../../🧠%20Memory/🗂️%20Tokens/token-exploitation-raison-sociale.md)**, SAS au capital de [Capital Exploitant](../../../🧠%20Memory/STRICT%20VARIABLES.md), immatriculée au RCS de [RCS Ville Exploitant](../../../🧠%20Memory/STRICT%20VARIABLES.md) sous le numéro [Siret Exploitant](../../../🧠%20Memory/STRICT%20VARIABLES.md), dont le siège social est sis [Adresse Exploitant](../../../🧠%20Memory/🗂️%20Tokens/token-exploitation-adresse.md), prise en la personne de son représentant légal en exercice,
   Assistée de son assureur responsabilité civile, **la compagnie [Assureur RC Exploitant](../../../🧠%20Memory/STRICT VARIABLES.md)**, prise en son agence de [Ville Agence Assureur RC](../../../🧠%20Memory/STRICT%20VARIABLES.md) sous le numéro de police [Numéro Contrat RC Exploitant](../../../🧠%20Memory/STRICT%20VARIABLES.md),
...
Le **[Date de l'Accident](../../../🧠%20Memory/STRICT%20VARIABLES.md)**, M. [La Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-nom-complet.md) a été victime d'un accident corporel grave alors qu'il se trouvait dans les locaux d'exploitation commerciale de la société [L'Exploitant](../../../🧠%20Memory/🗂️%20Tokens/token-exploitation-raison-sociale.md) situés au [Adresse Exploitant](../../../🧠%20Memory/🗂️%20Tokens/token-exploitation-adresse.md).

M. [La Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-nom-complet.md) a subi l'effondrement brutal d'une vasque suspendue en céramique défectueuse, lui occasionnant des lésions cutanées, tendineuses et nerveuses majeures à la **main droite (sa main dominante)**, ayant nécessité une intervention chirurgicale lourde en urgence (micro-chirurgie nerveuse et chirurgie orthopédique de reconstruction des tendons). Cet accident a entraîné une Interruption Totale de Travail (ITT) médico-légale de **56 jours**, ainsi que des séquelles neuropathiques douloureuses persistantes empêchant l'exercice normal de sa profession d'informaticien indépendant (développeur/codeur).
...
À titre de règlement provisionnel immédiat à valoir sur la liquidation définitive des préjudices corporels, et dans l'attente de l'expertise médicale d'évaluation finale après consolidation, la compagnie [Assureur RC Exploitant](../../../🧠%20Memory/STRICT VARIABLES.md) s'engage à verser à M. [La Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-nom-complet.md) la somme de **[Finance Provision Référé](../../../🧠%20Memory/🗂️%20Tokens/token-finance-provision-refere.md)**.

Ce versement interviendra par virement bancaire sur le compte CARPA de Me [L'Avocat de la Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-avocat-nom.md) dans un délai maximal de **quinze (15) jours** à compter de la signature des présentes par l'ensemble des Parties.
...
Fait le 14 juillet 2026,
En 3 exemplaires originaux.

| Pour la Victime | Pour l'Exploitant |
| :--- | :--- |
| **M. [La Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-nom-complet.md)** | **Le Représentant de [L'Exploitant](../../../🧠%20Memory/🗂️%20Tokens/token-exploitation-raison-sociale.md)** |
...
| | |
| **Me [L'Avocat de la Victime](../../../🧠%20Memory/🗂️%20Tokens/token-victime-avocat-nom.md)** | **La Compagnie [Assureur RC Exploitant](../../../🧠%20Memory/STRICT VARIABLES.md)** |
