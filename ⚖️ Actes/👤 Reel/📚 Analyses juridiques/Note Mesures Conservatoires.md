...
<!-- Breadcrumb -->
[🏠](../../../README.md) › [📁 Actes — Dossier Contentieux](../../README.md) › [📁 Actes / reel — Version Réelle](../README.md) › [Index — 📚 Analyses juridiques (Versions Réelles)](./README.md) › Note Mesures Conservatoires
<!-- /Breadcrumb -->
...
**Sur le principe de créance fondé :** Le dossier démontre de manière probante le dommage corporel subi par Sébastien GRAZIDE imputable à SAS LES MAUVAIS GARCONS. Les éléments médicaux et factuels établissent indéniablement la responsabilité et, par voie de conséquence, l'existence d'une créance indemnitaire d'un montant significatif, permettant de qualifier le principe de créance.
...
- **Saisie conservatoire des comptes bancaires :** Cette mesure vise à geler les fonds disponibles sur les comptes de SAS LES MAUVAIS GARCONS. Elle est particulièrement efficace et peut être pratiquée avec diligence par un Commissaire de Justice.
...
Afin de préserver les droits de Sébastien GRAZIDE, il est fortement recommandé de diligenter au plus vite une procédure sur requête aux fins d'être autorisé par le Juge de l'Exécution à faire pratiquer par un Commissaire de Justice :
