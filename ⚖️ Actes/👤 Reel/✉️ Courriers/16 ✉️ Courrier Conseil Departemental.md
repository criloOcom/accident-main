...
<!-- Breadcrumb -->
[🏠](../../../README.md) › [📁 Actes — Dossier Contentieux](../../README.md) › [📁 Actes / reel — Version Réelle](../README.md) › [Index — ✉️ Courriers (Versions Réelles)](./README.md) › 16 ✉️ Courrier Conseil Departemental
<!-- /Breadcrumb -->
...
Objet : Signalement de non-conformite d'un ERP — SAS SAS LES MAUVAIS GARCONS
...
**Installation du poste de television en hauteur sans equipement d'acces securise**
Le poste de television etait installe en hauteur, necessitant pour y acceder de monter sur le bac a shampoing. Cette configuration constitue un risque pour les personnes amenées a intervenir sur l'equipement et meconnait les obligations de securite applicables aux ERP.
