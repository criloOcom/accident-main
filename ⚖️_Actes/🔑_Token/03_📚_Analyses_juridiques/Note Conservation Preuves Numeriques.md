<!-- [🏠](../README.md) > 📁 [ ⚖️_Actes ](....../README.md) > 📁 [ 🔑_Token ](..../README.md) > 📁 [ 03_📚_Analyses_juridiques ](../README.md) > 📄 [ Note Conservation Preuves Numeriques.md ](.Note Conservation Preuves Numeriques.md) -->
...
Ces plateformes prouvent que la société était bien référencée et active à **[L'Adresse de l'Exploitation]** :
- **Societe.com** / **Infogreffe** : Permet de prouver l'immatriculation de **[L'Exploitant du Commerce (La SAS)]** sous son identifiant, l'identité de ses dirigeants (**[Le Président de l'Exploitation]**, **[La Directrice Générale de l'Exploitation]**), et l'adresse de son siège.
...
Il est impératif d'agir de manière proactive, avant même l'introduction de la procédure judiciaire formelle contre **[L'Exploitant du Commerce (La SAS)]**.
