...
<!-- Breadcrumb -->
[🏠](../../../README.md) › [📁 Actes — Dossier Contentieux](../../README.md) › [📁 Actes / reel — Version Réelle](../README.md) › [Index — 02_✉️_Courriers (Versions Réelles)](./README.md) › 38 ✅ CHECKLIST DEPLACEMENT POLICE FOIX
<!-- /Breadcrumb -->

# CHECKLIST COMPLÈTE — DÉPLACEMENT AU COMMISSARIAT DE FOIX

**Date prévue :** [Date à compléter]
**Heure de rendez-vous :** [Heure à compléter]
**Lieu :** Commissariat de Police de Foix - [Adresse à compléter]
**Objectif :** Déposer plainte complémentaire pour obstruction à la justice et dissimulation de preuves
...
- [ ] **PV initial n°2026/015967** : Copie certifiée conforme
...
- [ ] Douche et tenue professionnelle
- [ ] Petit-déjeuner équilibré
- [ ] Vérifier la météo finale
- [ ] Charger téléphone + batterie externe
- [ ] Vérifier les documents une dernière fois
- [ ] Préparer un sac à dos/serviette
...
- [ ] Présenter poliment la raison de la visite
...
- [ ] Présentation polie et professionnelle
- [ ] Remise du dossier complet
- [ ] Résumé oral des faits (2-3 minutes)
- [ ] Répondre aux questions avec précision
- [ ] Citer les articles de loi quand nécessaire

### Points à aborder

**✅ Présentation des faits :**
- [ ] Rappel de l'accident initial
- [ ] Obstruction à la justice (refus assurance RC)
- [ ] Dissimulation des preuves (vidéosurveillance)
- [ ] Société fantôme (courriers NPAI)
...
**✅ Questions à poser :**
- [ ] Numéro d'enregistrement de la plainte
- [ ] Nom de l'officier référent
...
- [ ] Numéro de dossier/plainte
- [ ] Nom et coordonnées de l'officier référent
- [ ] Date prévue pour les prochaines étapes
- [ ] Copie du procès-verbal (si possible)
...
- [ ] Coordonnées de suivi obtenues

### Remerciements

- [ ] Remercier l'officier pour son temps
- [ ] Exprimer la disponibilité pour suite
- [ ] Demander confirmation écrite des suites
- [ ] Noter l'heure de fin d'entretien
...
- [ ] Noter tous les éléments de l'entretien
- [ ] Scanner l'accusé de réception
...
- [ ] Préparer un compte-rendu écrit

### Dans les 48 heures

- [ ] Vérifier l'enregistrement du dossier
- [ ] Relancer si aucun accusé de réception
- [ ] Préparer une relance écrite si nécessaire
- [ ] Contacter l'officier référent

### Dans la semaine

- [ ] Suivre l'avancement de l'enquête
- [ ] Relancer si aucune action concrète
- [ ] Préparer une relance formelle si besoin
- [ ] Informer l'avocat (si mandaté)
