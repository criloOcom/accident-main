<!-- [🏠](../README.md) > 📁 [ ⚖️_Actes ](....../README.md) > 📁 [ 👤_Reel ](..../README.md) > 📁 [ 03_📚_Analyses_juridiques ](../README.md) > 📄 [ Note Conservation Preuves Numeriques.md ](.Note Conservation Preuves Numeriques.md) -->
---
...
- **Societe.com** / **Infogreffe** : Permet de prouver l'immatriculation de SAS LES MAUVAIS GARCONS sous son identifiant, l'identité de ses dirigeants (Sabir MOUNTASSER, Catherine ANDISSAC), et l'adresse de son siège.
