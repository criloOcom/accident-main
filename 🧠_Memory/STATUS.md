...
| #75 | Expertise barémique | ✅ Mergée (rebase) | `📊_Rapports/20260708_Rapport_Baremique_Dintilhac.md` |
...
| #82 | Ordonnance référé | ✅ Déjà mergée | `⚖️_Actes/🔑_Token/01_⚖️_Actes_proceduraux/07 ⚖️ Projet Ordonnance Refere.md` |
| #83 | Réquisitoire introductif (token) | ✅ Mergée (rebase + force push) | `⚖️_Actes/🔑_Token/01_⚖️_Actes_proceduraux/15 ⚖️ Réquisitoire introductif.md` |
| #84 | Mémoire défense adverse (token) | ✅ Mergée (rebase) | `⚖️_Actes/🔑_Token/03_📚_Analyses_juridiques/99 🛡️ Memoire en defense adverse.md` |

### Génération reel (#83, #84)
- `generate_real_versions.py` : 57 fichiers générés dans `⚖️_Actes/👤_Reel/`
...
- **0 nom réel** restant dans `⚖️_Actes/🔑_Token/`
...
- **Contributions extraites** → commit `5e90346` :
  ...
  - 6 fichiers `⚖️_Actes/🔑_Token/` enrichis : 32 insertions, 22 suppressions (ratios vérifiés, remplacement Art. 2226 → L.124-3 C.assur., ajout arrêts Soc. 11-14.339, Civ2 90-14.261, Civ2 15-15.306, Civ2 96-16.128)
...
### Ce qui a été fait
- **6 fiches jurisprudence créées** dans `📜_Lois/` avec texte intégral vérifié (Légifrance + Judilibre) et transposition au cas concret :
...
### State final
- `📜_Lois/` : 22 jurisprudences + 17 articles de loi = 39 fichiers
- `⚖️_Actes/🔑_Token/03_📚_Analyses_juridiques/` : 6 analyses (07, 09, 12, 13, 14 + README)
...
### Ce qui a été fait
- PIECES MAP.md créé dans `🧠_Memory/` avec mapping complet document→pièces
...
| Ajout | Détail |
|-------|--------|
| `📜_Lois/` | 16 textes juridiques (PDF→.md) du dossier Drive **00 Lois** + INDEX.md |
...
### Ce qui a été fait
- **Restructuration token/reel** : `⚖️_Actes/00-06` → `⚖️_Actes/🔑_Token/00-06/`, `⚖️_Actes/07_Reel` → `⚖️_Actes/👤_Reel/`, script `generate_real_versions.py` réécrit (scan multi-dossiers, génération dans `⚖️_Actes/👤_Reel/` avec sous-dossiers miroirs + README.md)
...
- **check_consistency.py corrigé** : patch URL decode (urllib.parse.unquote) + path ANNEXES `⚖️_Actes/🔑_Token/06_🗄️_Archives/annexes` → **0 erreur, 65 avertissements bénins** (`[À compléter]` placeholders)
...
- **Génération versions réelles** : 46 fichiers regénérés dans `⚖️_Actes/👤_Reel/` (incl. 5 nouveaux)
...
### Objectif
Standardiser TOUTES les citations de lois et jurisprudences dans `⚖️_Actes/🔑_Token/` selon un format unique :
...
- **63 fichiers total** dans `⚖️_Actes/🔑_Token/`
