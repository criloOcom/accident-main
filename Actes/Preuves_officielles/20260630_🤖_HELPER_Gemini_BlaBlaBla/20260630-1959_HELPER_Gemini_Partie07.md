...
graph TD
    ...
    A[Dommage Corporel de la Victime] --> B[Action directe contre l'assureur RC de la SAS]

    A --> C[Action pénale contre le préposé]

    A --> D[Action civile en faute détachable contre le Dirigeant]

    

    B --> B1[Garanti par l'Art. L. 124-3 C. Assurances]

    B --> B2[Insensible à la faillite/radiation]

    B --> B3[Couvre frais futurs et aggravation]

    

    C --> C1[Condamnation pénale sous art. 222-20 C. Pénal]

    C --> C2[Perte d'immunité civile - Arrêt Cousin]

    C --> C3[Action civile directe contre le préposé]

    

    D --> D1[Preuve de la faute détachable]

    D --> D2[Condamnation personnelle sur patrimoine]

    D --> D3[Arrêt Sati 2003 - Faute de gravité exceptionnelle]
...
graph TD
    ...
    A[Accident du 29/05/2026] --> B[Soins urgents]

    A --> C[Plainte pénale 02/06]

    A --> D[Déclaration CPAM 03/06]

    B --> E[Certificats médicaux]

    C --> F[Tribunal Correctionnel]

    D --> G[Recours contre tiers]

    E --> H[Expertise médicale]

    F --> I[Condamnation pénale]

    G --> J[Indemnisation CPAM]

    H --> K[Évaluation préjudices]

    I --> L[Responsabilité civile]

    J --> M[Subrogation CPAM]

    K --> N[Action directe assureur RC]

    L --> N

    M --> N

    N --> O[Indemnisation intégrale]

    O --> P[Paiement des dommages]

    P --> Q[Exécution forcée si nécessaire]
