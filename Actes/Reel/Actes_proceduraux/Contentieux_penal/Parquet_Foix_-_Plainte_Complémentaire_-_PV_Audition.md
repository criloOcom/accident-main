...
> « Je me nomme [Sébastien GRAZIDE](../../../../Memory/Tokens/token-victime-nom-complet.md), né(e) le [**[Date de naissance de la victime]**](../../../../Memory/Tokens/token-victime-date-naissance.md) à [Toulouse](../../../../Memory/Tokens/token-accident-metropole.md), de nationalité française, exerçant la profession d'informaticien indépendant.
...
>
> Par conséquent, je dépose formellement plainte aujourd'hui contre les dirigeants de la société [SAS LES MAUVAIS GARCONS](../../../../Memory/Tokens/token-exploitation-raison-sociale.md) pour ces nouveaux faits d'obstruction à la justice et de destruction de preuves, venant s'ajouter aux blessures involontaires par violation d'une obligation de sécurité (article 222-20 du Code pénal).
>
