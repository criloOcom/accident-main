...
[SAS LES MAUVAIS GARCONS](../../../../Memory/Tokens/token-exploitation-raison-sociale.md), Société par Actions Simplifiée, immatriculée au RCS de [Foix](../../../../Memory/Tokens/token-accident-ville.md) sous le numéro SIRET [938 033 222 00010](../../../../Memory/Tokens/token-exploitation-id.md), ayant son siège social au [22 Rue Lafaurie, 09000 Foix](../../../../Memory/Tokens/token-exploitation-adresse.md), représentée par ses co-dirigeants [Sabir MOUNTASSER](../../../../Memory/Tokens/token-exploitation-president-nom.md) et [Catherine ANDISSAC](../../../../Memory/Tokens/token-exploitation-dg-nom.md).
...
Le **29 mai 2026**, aux environs de 15 heures, [Sébastien GRAZIDE](../../../../Memory/Tokens/token-victime-nom-complet.md), informaticien indépendant âgé de [**[Âge de la Victime]**](../../../../Memory/Tokens/token-victime-age.md), se trouvait en qualité de client dans le salon de coiffure exploité par la société défenderesse.
...
Au cours de cette manipulation, la vasque a **basculé** brutalement et s'est brisée. Par réflexe de protection, [Sébastien GRAZIDE](../../../../Memory/Tokens/token-victime-nom-complet.md) a tendu sa main droite — sa main dominante — pour protéger le préposé.
...
Le commissariat de police a dressé le procès-verbal n°[2026/015967](../../../../Memory/Tokens/token-pv-police-numero.md) qui confirme le basculement de la vasque. Ce procès-verbal constitue une pièce décisive établissant le mécanisme de l'accident.
...
Le **basculement brutal** de cette chose a été l'**instrument actif** du dommage subi par la victime. Ce basculement est établi par le procès-verbal de police n°[2026/015967](../../../../Memory/Tokens/token-pv-police-numero.md).
