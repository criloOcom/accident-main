...
- [Synthèse des faits, pièces administratives et stratégie de recouvrement - Affaire [Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md)](#synthse-des-faits-pices-administratives-et-stratgie-de-recouvrement---affaire-la-victime)
...
Ce choc a provoqué une section profonde de 8,5 cm au niveau de sa paume droite (main dominante, pince pouce-index). [Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md) a été opéré le samedi [30 mai 2026](../../../Memory/Tokens/token-j-1-chirurgie.md) par le [Dr Iskander DJERBI](../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md) au service SOS Main de [Clinique de l'Union](../../../Memory/Tokens/token-hopital-sosmain-nom.md).
...
- Pièce 06 (Acte 3) - Assignation en référé provision (Tribunal de [Foix](../../../Memory/Tokens/token-accident-ville.md)) : Modèle d'assignation pour provision de 5 000 €.
