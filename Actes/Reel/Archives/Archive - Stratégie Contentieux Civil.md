...
La mise en demeure de l'assureur a été adressée le [29 juin 2026](../../../Memory/Tokens/token-j-31-mises-en-demeure.md), enjoignant à la compagnie de prendre en charge le sinistre et de procéder au règlement des préjudices sous 15 jours.
...
Une assignation en [référé-provision](https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000042597284)[^6] (article 835 du Code de procédure civile) a été rédigée le [30 juin 2026](../../../Memory/Tokens/token-j-32-assignation-refere.md) pour solliciter une provision de 5 000 € à valoir sur l'indemnisation définitive.
...
**Procédure :** La victime saisit la Commission d'Indemnisation des Victimes d'Infractions (CIVI) du Tribunal Judiciaire de [Foix](../../../Memory/Tokens/token-accident-ville.md), qui statue sur le droit à indemnisation et fixe le montant.
...
- La victime dispose de **3 ans** à compter de la date de l'infraction ([29 mai 2026](../../../Memory/Tokens/token-j-0-accident.md) → 29 mai 2029) pour saisir la CIVI (Article 706-5 CPP).

- Si une décision pénale définitive intervient, ce délai est ramené à **1 an** à compter de cette décision.

- En l'état de l'enquête préliminaire en cours, la date de référence est celle de l'infraction ([29 mai 2026](../../../Memory/Tokens/token-j-0-accident.md)).
...
Pièces médicales :
- [29 mai 2026](../../../Memory/Tokens/token-j-0-accident.md) — [Dr Julie JARDON](../../../Memory/Tokens/token-hopital-urgence-medecin.md) — Premiers soins urgence

- [30 mai 2026](../../../Memory/Tokens/token-j-1-chirurgie.md) — [Dr Iskander DJERBI](../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md) — CR opératoire

- [30 mai 2026](../../../Memory/Tokens/token-j-1-chirurgie.md) — [Dr Iskander DJERBI](../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md) — Ordonnance de sortie

- [10 juin 2026](../../../Memory/Tokens/token-j-12-facture.md) — [Dr Iskander DJERBI](../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md) — Facture chirurgie 790,23 €

- [19 juin 2026](../../../Memory/Tokens/token-j-21-controle-chirurgical.md) — [Dr Iskander DJERBI](../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md) — CR contrôle J+20

- [30 juin 2026](../../../Memory/Tokens/token-j-32-assignation-refere.md) — [Dr Julie JARDON](../../../Memory/Tokens/token-hopital-urgence-medecin.md) — Consultation urgence J+32

- [1 juillet 2026](../../../Memory/Tokens/token-j-33-plainte-complementaire.md) — [Dr Oxybel](../../../Memory/Tokens/token-victime-medecin-generaliste.md) — Consultation générale J+33

- [8 juillet 2026](../../../Memory/Tokens/token-j-40-consultation-suivi.md) — [Dr Iskander DJERBI](../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md) — CR de reprise J+39

Pièces financières :
- [29 mai 2026](../../../Memory/Tokens/token-j-0-accident.md) — Wero — Preuve de paiement / remboursement

Pièces administratives :
- [3 juin 2026](../../../Memory/Tokens/token-j-5-ouverture-cpam.md) — CPAM Haute-Garonne — Dossier RCT [31727387](../../../Memory/Tokens/token-cpam-dossier-numero.md)

- [1 juin 2026](../../../Memory/Tokens/token-j-3-premiers-arrets.md) — INSEE — Avis de situation SAS

- [1 juin 2026](../../../Memory/Tokens/token-j-3-premiers-arrets.md) — INPI — Fiche identité SAS
