...
**Note :** À ce jour, aucun accusé de réception officiel ni numéro de suivi de la préfecture n'a été communiqué à [Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md). Les informations relatives à la saisine de la préfecture proviennent exclusivement du courriel de la Mairie de [Foix](../../../Memory/Tokens/token-accident-ville.md).

### 3.2 CONSTITUTION DE PARTIE CIVILE

Une constitution de partie civile a été formée par [Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md) le [30 juin 2026](../../../Memory/Tokens/token-j-32-assignation-refere.md) devant le Tribunal Correctionnel de [Foix](../../../Memory/Tokens/token-accident-ville.md). Cette démarche, fondée sur les articles 2 et suivants du Code de procédure pénale, permet à [Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md) de :
...
- **3 ans** à compter de l'infraction ([29 mai 2026](../../../Memory/Tokens/token-j-0-accident.md) → 29 mai 2029) pour saisir la CIVI (Article 706-5 CPP).

- Ou **1 an** après une décision pénale définitive si elle intervient avant l'expiration du délai de 3 ans.

**Procédure :** Saisine de la Commission d'Indemnisation des Victimes d'Infractions (CIVI) du Tribunal Judiciaire de [Foix](../../../Memory/Tokens/token-accident-ville.md), qui notifie le FGTI et instruit la demande d'indemnisation.
...
Pièces pénales :
- [1 juin 2026](../../../Memory/Tokens/token-j-3-premiers-arrets.md) — [Foix](../../../Memory/Tokens/token-accident-ville.md) Police — Dépôt de plainte officiel [🔗 Voir](https://drive.google.com/file/d/1estaaOWMphbrt5VXhy6MsTfHqBGIdj22/view)

- [2 juin 2026](../../../Memory/Tokens/token-j-4-depot-de-plainte.md) — [Foix](../../../Memory/Tokens/token-accident-ville.md) Police — Procès-verbal constat n°[2026/015967](../../../Memory/Tokens/token-pv-police-numero.md) [🔗 Voir](https://drive.google.com/file/d/1YXaJE81FFPTKcrcShg9DI5jUZ82T988V/view)

- [2 juin 2026](../../../Memory/Tokens/token-j-4-depot-de-plainte.md) — [Foix](../../../Memory/Tokens/token-accident-ville.md) Police — Constitution de partie civile

- [2 juin 2026](../../../Memory/Tokens/token-j-4-depot-de-plainte.md) — [Foix](../../../Memory/Tokens/token-accident-ville.md) Police — Complément de plainte
