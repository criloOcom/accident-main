...
1. **M. [Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md), né le [**[Date de Naissance de la Victime]**](../../../Memory/Tokens/token-victime-adresse.md),
...
À titre de règlement provisionnel immédiat à valoir sur la liquidation définitive des préjudices corporels, et dans l'attente de l'expertise médicale d'évaluation finale après consolidation, la compagnie [**[Assureur RC Exploitant]**](../../../Memory/Tokens/token-victime-nom-complet.md) la somme de [15 000 €](../../../Memory/Tokens/token-finance-provision-refere.md).
...
| :--- | :--- |
| **M. [Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md) | **Le Représentant de [**[L'Exploitant]**](../../../Memory/Tokens/token-exploitation-raison-sociale.md) |
