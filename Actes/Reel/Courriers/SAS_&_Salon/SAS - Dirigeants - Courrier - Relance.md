...
- **[SAS HB BARBER](../../../../Memory/Tokens/token-exploitation-raison-sociale.md)** (LRAR n° **N° LRAR Exploitant**) : distribution impossible.

- Madame **[Catherine SORROCHE, dite ANDISSAC](../../../../Memory/Tokens/token-exploitation-dg-nom.md)** (LRAR n° **N° LRAR Directrice**) : retour à l'expéditeur pour défaut d'adresse.

- Monsieur **[Hamza El Hachemi BERGUIGA](../../../../Memory/Tokens/token-exploitation-president-nom.md)** (LRAR n° **N° LRAR Président**) : en attente de retrait.

Seuls le bailleur, le tribunal judiciaire de **[Foix](../../../../Memory/Tokens/token-accident-ville.md)** et la CPAM ont accusé réception de leurs courriers respectifs.
...
J'ai constaté que votre salon de coiffure a fermé ses portes immédiatement après l'accident du **[29 mai 2026](../../../../Memory/Tokens/token-j-0-accident.md)** pour ne rouvrir que le [6 juillet 2026](../../../../Memory/Tokens/token-exploitation-date-reouverture.md). 
...
Cette percussion m'a sectionné le tendon et les nerfs de l'index droit, blessure grave ayant nécessité une chirurgie réparatrice d'urgence le **[30 mai 2026](../../../../Memory/Tokens/token-j-1-chirurgie.md)** par **[Dr Iskander DJERBI](../../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md)** à **[Clinique de l'Union](../../../../Memory/Tokens/token-hopital-sosmain-nom.md)**.
...
1. Le nom et les coordonnées de l'assureur RC professionnelle de votre société au **[29 mai 2026](../../../../Memory/Tokens/token-j-0-accident.md)** ;
...
2. Saisir le juge des référés du tribunal judiciaire de **[Foix](../../../../Memory/Tokens/token-accident-ville.md)** par voie de **requête** (non contradictoire, afin de préserver l'effet de surprise) sur le fondement de l'article 145 du Code de procédure civile, pour ordonner sous astreinte la communication des documents ;
