...
---
<!-- Breadcrumb -->
*[🏠](../../../README.md) › [📁 Actes — Dossier Contentieux](../../README.md) › [🎭 Actes / token — Version Anonymisée](../README.md) › [📚 Analyses Juridiques](./README.md) › Note - Qualification Pénale Disparition SAS*
<hr>
<!-- /Breadcrumb -->
...
**Dossier :** **[Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md)** c/ **[SAS HB BARBER](../../../Memory/Tokens/token-exploitation-raison-sociale.md)**
**Rédacteur :** **[Nom Prénom de l'Avocat](../../../Memory/Tokens/token-victime-avocat-nom.md)**
## I — INTRODUCTION

La présente note vise à analyser les qualifications pénales applicables dans l'hypothèse où **[Hamza El Hachemi BERGUIGA](../../../Memory/Tokens/token-exploitation-president-nom.md)** et **[Catherine SORROCHE, dite ANDISSAC](../../../Memory/Tokens/token-exploitation-dg-nom.md)** procéderaient à la liquidation, la dissolution ou la cession des actifs de **[SAS HB BARBER](../../../Memory/Tokens/token-exploitation-raison-sociale.md)** (dont le [1 000 €](../../../Memory/Tokens/token-exploitation-capital-social.md)) dans le but d'échapper au paiement des condamnations civiles à intervenir au profit de **[Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md)**.
...
**Problématique :**
La société **[SAS HB BARBER](../../../Memory/Tokens/token-exploitation-raison-sociale.md)** pourrait être vidée de ses actifs par ses dirigeants avant même que notre action en responsabilité civile n'aboutisse.

**Argumentation :**
L'article 314-7 du Code pénal permet expressément d'appréhender le comportement du débiteur qui organise son insolvabilité *avant même* que la décision de justice ne soit rendue. Si **[Hamza El Hachemi BERGUIGA](../../../Memory/Tokens/token-exploitation-president-nom.md)** et **[Catherine SORROCHE, dite ANDISSAC](../../../Memory/Tokens/token-exploitation-dg-nom.md)** décident de dissoudre la structure ou de transférer le fonds de commerce à une autre entité sans provisionner le passif latent lié à l'accident du 29 mai 2026, l'infraction sera pleinement constituée. La peine encourue (jusqu'à 5 ans de prison et 375 000 € d'amende avec circonstances aggravantes) justifie la saisine du Parquet.
...
**Problématique :**
Dans l'hypothèse où une nouvelle société serait créée par **[Hamza El Hachemi BERGUIGA](../../../Memory/Tokens/token-exploitation-president-nom.md)** ou **[Catherine SORROCHE, dite ANDISSAC](../../../Memory/Tokens/token-exploitation-dg-nom.md)** pour reprendre les actifs de **[SAS HB BARBER](../../../Memory/Tokens/token-exploitation-raison-sociale.md)** sans en reprendre le passif.

**Argumentation :**
Le montage juridique consistant à recréer une entité miroir (même activité, même clientèle, mêmes dirigeants) pour transférer frauduleusement le fonds de commerce, tout en laissant la coquille vide **[SAS HB BARBER](../../../Memory/Tokens/token-exploitation-raison-sociale.md)** faire face aux dettes indemnitaires, constitue une manœuvre frauduleuse. Cette manœuvre visant à tromper les créanciers (ici, **[Sébastien GRAZIDE](../../../Memory/Tokens/token-victime-nom-complet.md)**) pour obtenir une décharge d'obligation caractérise le délit d'escroquerie, puni de 5 ans d'emprisonnement et 375 000 € d'amende.
<hr><hr>
...
**Argumentation :**
Si **[SAS HB BARBER](../../../Memory/Tokens/token-exploitation-raison-sociale.md)** fait l'objet d'une procédure collective, les actes de dissipation du patrimoine social accomplis par **[Hamza El Hachemi BERGUIGA](../../../Memory/Tokens/token-exploitation-president-nom.md)** ou **[Catherine SORROCHE, dite ANDISSAC](../../../Memory/Tokens/token-exploitation-dg-nom.md)** tomberont sous le coup des dispositions relatives à la banqueroute. La dissimulation d'actifs, le détournement ou l'emploi ruineux des fonds sociaux (notamment en fuyant le passif) justifieront un signalement au Procureur de la République.
<hr><hr>

## V — CONCLUSION

La faiblesse du [1 000 €](../../../Memory/Tokens/token-exploitation-capital-social.md) de **[SAS HB BARBER](../../../Memory/Tokens/token-exploitation-raison-sociale.md)** impose une vigilance extrême. Si la société vient à disparaître ou à être vidée de sa substance, une plainte avec [constitution de partie civile](../Actes_proceduraux/Contentieux_penal/DJI%20Foix%20-%20Partie%20Civile%20-%20Constitution.md) devra être déposée entre les mains du Doyen des juges d'instruction ou directement au Parquet, ciblant personnellement **[Hamza El Hachemi BERGUIGA](../../../Memory/Tokens/token-exploitation-president-nom.md)** et **[Catherine SORROCHE, dite ANDISSAC](../../../Memory/Tokens/token-exploitation-dg-nom.md)**.
<!-- Source -->
<hr><hr>
