...
---
<!-- Breadcrumb -->
*[🏠](../../../README.md) › [📁 Actes](../../README.md) › [🎭 Token](../README.md) › [Preuves officielles](./README.md) › 20270529 Rapport Expertise Medicale ([👤](../../Reel/Preuves_officielles/20270529_Rapport_Expertise_Medicale.md))*
<hr>
<!-- /Breadcrumb -->
...
**Date de l'examen :** 29 mai 2027
**Date du rapport :** 12 juin 2027
...
**DÉSIGNATION :** Par ordonnance de référé du **31 juillet 2026** (RG n°[N° RG]), Monsieur le Président du Tribunal Judiciaire de **[La Ville de l'Accident](../../../Memory/Tokens/token-accident-ville.md)** a commis l'expert pour procéder à l'examen médical de **[La Victime](../../../Memory/Tokens/token-victime-nom-complet.md)** et évaluer l'ensemble des préjudices corporels découlant de l'accident du 29 mai 2026.

---

### I.1 — CONVOCATION ET DÉROULEMENT DES OPÉRATIONS

L'expert a convoqué **[La Victime](../../../Memory/Tokens/token-victime-nom-complet.md)** par lettre recommandée du 24 avril 2027. L'examen médical a eu lieu au cabinet de l'expert le **29 mai 2027** en présence du requérant seul, ce dernier n'ayant pas constitué avocat et la partie défenderesse n'ayant pas comparu aux opérations d'expertise bien que régulièrement convoquée.
...
- Procès-verbal de police n°[**[N° PV Police]**](../../../Memory/Tokens/token-pv-police-numero.md) (28 juin 2026)

- [Certificat médical initial](../../Preuves%20officielles/20260529_Dr[MEDECIN_TRAITANT]/20260529-1630%20SITUATION%20DrJulie[MEDECIN_TRAITANT].md) du Dr **[Le Médecin en Urgence](../../../Memory/Tokens/token-hopital-urgence-medecin.md)** (SMUR), 29 mai 2026

- [Compte-rendu opératoire](../../Preuves%20officielles/20260530%20%F0%9F%86%98%20SOSMain/20260530%20CR%20Op%C3%A9ratoire%20RapportInterventionMainDroite.md) du **[Le Chirurgien SOS Main](../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md)** (SOS Main), 30 mai 2026
...
- Correspondance médicale entre le médecin traitant **[Le Médecin Généraliste](../../../Memory/Tokens/token-victime-medecin-generaliste.md)** et le chirurgien SOS Main

---

### I.3 — RAPPEL DES FAITS ET DES SOINS REÇUS

Le **29 mai 2026**, vers 15 heures, **[La Victime](../../../Memory/Tokens/token-victime-nom-complet.md)**, alors âgé de 44 ans et exerçant la profession d'informaticien indépendant, se trouvait en qualité de client dans le salon de coiffure exploité par **[L'Exploitant du Commerce (La SAS)](../../../Memory/Tokens/token-exploitation-raison-sociale.md)** au **[L'Adresse de l'Exploitation](../../../Memory/Tokens/token-exploitation-adresse.md)**.

Le préposé de l'établissement a entrepris de régler un téléviseur fixé en hauteur. En l'absence de tout équipement d'accès (escabeau, marchepied), il est monté sur la vasque en céramique du bac à shampoing. Sous le poids, la vasque a basculé et s'est descellée du mur. Par réflexe, **[La Victime](../../../Memory/Tokens/token-victime-nom-complet.md)** a tendu la main droite pour protéger le préposé et a heurté une cassure majeure préexistante non signalée aux arêtes tranchantes, située sur le rebord de la vasque fracturée.
...
**Intervention chirurgicale (30 mai 2026) :** Le **[Le Chirurgien SOS Main](../../../Memory/Tokens/token-hopital-sosmain-chirurgien.md)** (SOS Main) a pratiqué :
...
**[La Victime](../../../Memory/Tokens/token-victime-nom-complet.md)**, droitier, déclare :
...
| Mouvement | Index droit (lésé) | Index gauche (sain) |
|-----------|-------------------|-------------------|
| Flexion MCP | 85° (normale) | 90° |
| Flexion IPP | 95° (normale) | 100° |
| Flexion IPD | **25°** (limitée) | **65°** |
| Extension MCP/IPP/IPD | **-5°** (déficit extension IPD) | 0° |
| Abduction/adduction | Normales | Normales |

**3. Force de préhension (JAMAR, position 2)**

| Main | Mesure 1 | Mesure 2 | Mesure 3 | Moyenne |
|------|----------|----------|----------|---------|
| **Droite (lésée)** | 31 kg | 33 kg | 30 kg | **31,3 kg** |
| **Gauche (saine)** | 46 kg | 44 kg | 45 kg | **45 kg** |

Ratio dominant/non-dominant : 31,3 / 45 = **69,6 %** (ratio attendu chez un droitier sans lésion : ~105-110 %)

**Force de pince (pouce-index) :**

| Type | Droite | Gauche |
|------|--------|--------|
| Pince pollicidigitale (Key pinch) | 4,2 kg | 8,5 kg |
| Pince pulpipulpaire (Tip pinch) | **2,8 kg** | 6,1 kg |

**4. Sensibilité**

| Test | Index droit | Index gauche | Valeur normale |
|------|------------|-------------|----------------|
| Monofilaments Semmes-Weinstein (face palmaire radiale) | **3,61** (protection) | 2,83 (normale) | ≤ 2,83 |
| Discriminatio sensitif statique (Test de Weber) | **8 mm** | 3 mm | ≤ 5 mm |
| Discrimination dynamique (Test de Dellon) | 6 mm | 2 mm | ≤ 4 mm |
...
L'ensemble des lésions décrites (section du tendon fléchisseur profond, du paquet collatéral radial, neurolyse du nerf palmaire de l'index droit) est en lien direct, certain et exclusif avec l'accident du 29 mai 2026. Aucun état antérieur n'a été relevé dans le dossier médical ni déclaré par l'intéressé. L'imputabilité est totale.
...
L'état de **[La Victime](../../../Memory/Tokens/token-victime-nom-complet.md)** peut être considéré comme **consolidé au 1er mars 2027**, avec les séquelles décrites ci-dessus. Les lésions conservent un caractère définitif, sans perspective d'amélioration notable à ce stade.

**3. Séquelles — analyse par poste**

- **DFP :** Le déficit fonctionnel permanent résulte de la perte de mobilité de l'IPD de l'index, de la diminution de force de préhension et de la sensibilité altérée dans le territoire radial de l'index droit. Chez un informaticien dont la main droite est l'outil de travail principal, ces séquelles sont particulièrement pénalisantes. Le taux de 12 % est justifié par la combinaison des atteintes sensitivo-motrices fonctionnelles.

- **SE :** La cotation à **4/7** (moyen) est justifiée par : une microchirurgie d'urgence sous anesthésie locorégionale, 4 semaines d'immobilisation stricte, 8 mois de rééducation quotidienne incluant des séances de désensibilisation douloureuses, et des douleurs neuropathiques post-opératoires ayant nécessité un traitement antalgique de palier 2 pendant 6 semaines.

- **PEP :** Cicatrice palmaire de 5,2 cm, visible (légèrement adhérente), avec zone d'anesthésie localisée. Cotation **2,5/7**.

- **IP :** Incidence professionnelle majeure chez un droitier indépendant dont le métier repose sur la dextérité de la main droite. La perte de vitesse d'exécution, la fatigabilité accrue, l'impossibilité de supporter des charges prolongées et l'impact sur l'image de compétence constituent une dévalorisation durable sur le marché du travail.
...
Voir supra III et V — lésions imputables à l'accident du 29 mai 2026 : section complète du paquet collatéral radial de l'index droit (nerf + artère), section du tendon fléchisseur profond de l'index en zone II de Verdan, nécessitant une microchirurgie réparatrice.

**2. Déterminer la date de consolidation**

**Consolidation fixée au 1er mars 2027**, soit 9 mois après l'accident. Délai cohérent avec la durée de récupération nerveuse après réparation microchirurgicale (1 mm/jour).
...
**4. Évaluer le déficit fonctionnel permanent (DFP)**

**Taux retenu : 12 %** (douze pour cent)
...
**Valorisation DFP : 12 % × 2 100 € × 1 (sans correctif) = 25 200 €**

(À titre indicatif, fourchette : 20 000 € - 30 000 € selon la valeur de point retenue)

**5. Évaluer les souffrances endurées (SE)**

**Cotation retenue : 4/7 (moyen)**
...
**6. Évaluer le préjudice esthétique permanent (PEP)**

**Cotation retenue : 2,5/7**

Cicatrice palmaire longitudinale de 5,2 cm, visible socialement (serrage de main, gestes de la main). Discrètement adhérente dans son tiers distal. Zone d'anesthésie localisée de 0,5 cm².

**Valorisation : 3 500 €** (fourchette : 2 500 — 5 000 €)
...
**Valorisation : 28 000 €** (fourchette : 20 000 — 35 000 €, méthode BIBAL : revenu annuel 9 000 × taux IP 12 % × coefficient 25 = 27 000 € ; cohérent)
...
- **Préjudice sexuel :** Aucun élément clinique documenté. **Néant.**

---

### I.8 — CONCLUSION

Au terme de nos opérations, et après examen de **[La Victime](../../../Memory/Tokens/token-victime-nom-complet.md)** le 29 mai 2027, nous concluons :
...
Sous toutes réserves, le préjudice corporel global de **[La Victime](../../../Memory/Tokens/token-victime-nom-complet.md)** (y compris postes patrimoniaux) peut être évalué dans une **fourchette globale de 120 000 € à 160 000 €**, dans l'attente du décompte CPAM et de la justification des pertes de gains futurs.

Fait à **[La Métropole Régionale](../../../Memory/Tokens/token-accident-metropole.md)**, le 12 juin 2027.
...
|-----------|-------|------------------|------------|-------------|
| **Temporaire** | DFT | **2 031 €** | 1 800 — 2 200 € | 56 j 100 % + 35 j 50 % + 95 j 25 % |
| | DSA | *(décompte CPAM)* | | Facture SOS Main 790,23 € + kiné, pharmacie |
| | PGPA | *(décompte)* | | 56 j d'ITT ; IJ CPAM à déduire |
| | Frais divers | *(à justifier)* | | Déplacements, aménagements urgents |
| | Aide humaine temporaire | **800 €** | 500 — 1 000 € | Entourage, ITT totale |
| **Permanent** | DFP (12 %) | **25 200 €** | 20 000 — 30 000 € | Point Mornet médian 2 100 € |
| | SE (4/7) | **14 000 €** | 10 000 — 18 000 € | Médian retenu |
| | PEP (2,5/7) | **3 500 €** | 2 500 — 5 000 € | Cicatrice palmaire visible |
| | Incidence professionnelle | **28 000 €** | 20 000 — 35 000 € | BIBAL : 9 000 × 12 % × coeff 25 = 27 000 € |
| | PGPF | *(projection)* | 50 000 — 70 000 € | Perte capacité gain ; dépend du suivi pro |
| | Préjudice d'agrément | **4 500 €** | 3 000 — 6 000 € | Codage loisir réduit |
| | Dépenses santé futures | **3 000 €** | 2 000 — 4 000 € | Suivi, ergonomie, renouvellement |
| | Préjudice sexuel | **0 €** | — | Aucun élément |

**Total extra-patrimonial (expert) :** **49 231 €**
**Total tous postes estimés (hors PGPF/DSA/PGPA) :** **81 031 €**
**Fourchette globale indicatives (y compris postes patrimoniaux) :** **120 000 — 160 000 €**

---

### NOTE MÉTHODOLOGIQUE

Ce rapport est une **simulation** rédigée à partir des pièces médicales et juridiques du dossier. Il ne constitue pas un rapport d'expertise réel.

**Écarts assumés avec les évaluations antérieures :**

| Poste | Simulation expert | Avis Dintilhac 13/07 (prudent) | Avis Dintilhac 13/07 (médian) | Commentaire |
|------|-----------------|-------------------------------|------------------------------|-------------|
| DFP (12 %) | 25 200 € | 20 000 € (10 %) | 30 000 € (15 %) | Expert retient 12 % — position intermédiaire argumentée |
| SE (4/7) | 14 000 € | 12 000 € | 15 000 € | Cohérent avec le médian de l'avis |
| IP | 28 000 € | 20 000 € | 30 000 € | Justification clinique renforcée |
| DFT calculé | 81,25 j (2 031 €) | 56 j (1 400 €) | 56 j (1 400 €) | Expert détaille DFT partiel post-ITT — plus précis |
