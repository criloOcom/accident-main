...
uid: Rt7kPwX9m
emoji: ✉️
title: SAMU 09 — Relance et actualisation du dossier — Appel du 29 mai 2026
description: Courriel de relance au DPO du GHT des Pyrénées Ariégeoises — remerciements pour la prise en charge, actualisation médicale et rappel de l'importance des données de régulation dans le cadre de la procédure judiciaire en cours
type: courrier
date: 2026-07-24
tags:
- relance
...
**Objet : Accident du [**[J+0 Accident]**](../../../../Memory/Tokens/token-j-0-accident.md) – Relance de la demande de communication des données de régulation médicale (appel SAMU 09) – Actualisation médicale**
...
Je fais suite à ma demande du 18 juillet 2026, adressée par courrier recommandé avec accusé de réception (n° [**[N° LRAR CHIVA]**](../../../../Memory/Tokens/token-lrar-chiva.md)) à Monsieur le Directeur du GHT des Pyrénées Ariégeoises – CHIVA, ainsi que par courriel du même jour à votre service.
...
Mon arrêt de travail total a cessé le [**[J+55 Fin d'ITT]**](../../../../Memory/Tokens/token-j-55-fin-d-itt.md), après 55 jours consécutifs. [**[Le Médecin de Suivi]**](../../../../Memory/Tokens/token-medecin-de-suivi.md) m'a prescrit un temps partiel thérapeutique à compter du 24 juillet 2026 pour une durée d'un mois.

Le dernier bilan du kinésithérapeute objective des séquelles fonctionnelles persistantes de l'index droit (raideur, limitation de la flexion). L'état n'est pas consolidé. Une expertise médico-légale est d'ores et déjà fixée au [**[J+167 Expertise UMJ]**](../../../../Memory/Tokens/token-j-167-expertise-umj.md) dans le cadre de la procédure judiciaire en cours.

L'état général demeure bon et la rééducation progresse favorablement.

---

## III — Contexte procédural

La procédure ouverte à la suite de mon dépôt de plainte (PV n° [**[N° PV Police]**](../../../../Memory/Tokens/token-pv-police-numero.md)) se poursuit. À ce stade, la partie exploitante des locaux où l'accident est survenu ([**[L'Exploitant du Commerce (La SAS)]**](../../../../Memory/Tokens/token-exploitation-raison-sociale.md) — SIREN [**[SIREN de l'Exploitation]**](../../../../Memory/Tokens/token-exploitation-siren.md)) n'a apporté aucune réponse aux différentes lettres recommandées qui lui ont été adressées, ni communiqué les coordonnées de son assureur de responsabilité civile.

Dans ces conditions, il m'apparaît que l'absence de constatation directe sur les lieux par les services de secours — la gravité de la blessure m'ayant conduit à me rendre par mes propres moyens au centre de soins immédiats sans attendre l'arrivée des pompiers — ne permet pas aujourd'hui de suppléer, par un procès-verbal de constat, le silence observé par la partie adverse.
