...
Les elements suivants sont susceptibles de caracteriser un travail dissimule par dissimulation d'emploi salarie (Article L.8221-5 du Code du[^n2] travail) :
...
- Malgre une demande restee sans reponse, aucun DUERP n'a ete communique, alors que ce document est obligatoire dans tout etablissement employant au moins un salarie (Article R.4121-1 du Code du[^n3] travail)<br>
...
Conformement a l'Article L.8271-1-2 du Code du[^n4] travail, les agents de l'URSSAF sont competents pour rechercher et constater les infractions de travail dissimule.
