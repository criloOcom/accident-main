...
Le **[J+0 Accident](../../../../Memory/Tokens/token-j-0-accident.md)**, alors que je me trouvais dans l'etablissement exploite par cette societe, j'ai ete temoin de la presence d'une personne physique ([Le Prepose de l'Exploitation]) exercant une activite de coiffeur.
...
Les elements suivants sont susceptibles de caracteriser un travail dissimule par dissimulation d'emploi salarie (Article L.8221-5 du Code du travail[^n2]) :
...
- Malgre une demande restee sans reponse, aucun DUERP n'a ete communique, alors que ce document est obligatoire dans tout etablissement employant au moins un salarie (Article R.4121-1 du Code du travail[^n3])<br>
...
1. La situation de [**[Le Prepose de l'Exploitation]**](../../../../Memory/Tokens/token-exploitation-prepose-nom.md) (tél. [**[Le Téléphone du Préposé]**](../../../../Memory/Tokens/token-exploitation-prepose-telephone.md)) au regard des declarations sociales (DPAE, bulletin de paie)<br>
<br>
...
- **[PV n°2026/015967](../../../Preuves_officielles/20260602_Police_PV/20260602_PV_Police_PV_n°2026-015967_AccidentSalonCoiffure.md)** — Procedure penale, depot de plainte du [J+4]
