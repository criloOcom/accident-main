...
- **Principe de réparation intégrale (Art. 1240[^n2] C. civ.) :** La victime doit être replacée dans la situation qui était la sienne avant le dommage, sans perte ni profit. Pour [**[La Victime]**](../../../Memory/Tokens/token-victime-nom-complet.md), informaticien indépendant, l'incidence professionnelle est majeure.
<hr><hr>
