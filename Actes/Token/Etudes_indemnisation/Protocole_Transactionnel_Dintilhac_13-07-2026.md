...
1. **M. [**[La Victime]**](../../../Memory/Tokens/token-victime-nom-complet.md), né le [**[Date de Naissance de la Victime]**](../../../Memory/Tokens/token-victime-adresse.md),
   Assisté de **Me [**[L'Avocat de la Victime]**](../../../Memory/Tokens/token-victime-avocat-nom.md), Avocat au Barreau de [Barreau Avocat Victime](../../../Memory/STRICT VARIABLES.md),
...
La société [**[L'Exploitant]**](../../../Memory/Tokens/token-exploitation-raison-sociale.md) (et par délégation son assureur la compagnie [Assureur RC Exploitant](../../../Memory/STRICT VARIABLES.md) reconnaît son entière et exclusive responsabilité dans la survenance du sinistre du [Date de l'Accident](../../../Memory/STRICT VARIABLES.md) sur le fondement de la responsabilité du fait des choses que l'on a sous sa garde (article 1242 alinéa 1er du Code civil).
...
La Victime conserve expressément le droit de solliciter une indemnisation complémentaire en cas d'aggravation future de son état de santé liée aux suites directes de l'accident du [Date de l'Accident](../../../Memory/STRICT VARIABLES.md), dûment constatée par un médecin expert.
