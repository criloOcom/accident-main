...
- [ ] `memory/TODO.md` — plans restants et priorités
- [ ] `memory/DECISIONS.md` — décisions d'architecture et règles
- [ ] `memory/RULES.md` — règles permanentes, interdictions
- [ ] `memory/STRICT VARIABLES.md` — source unique de vérité (montants, dates)
