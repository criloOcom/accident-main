...
Suite à l'analyse exhaustive des fichiers du répertoire `actes/token/` (sous-dossiers 00 à 06) afin de détecter la présence éventuelle de données personnelles réelles (noms propres hors crochets, numéros de téléphone, adresses e-mail, adresses postales complètes, numéros SIRET/SIREN, etc.), voici le résultat :
