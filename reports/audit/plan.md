1. **Créer le fichier `memory/NOTE_SYNTHESE_AVOCAT.md`**
   ...
   - Créer un tableau des parties avec tokens et identités réelles d'après `memory/TOKEN MAP.md` (victime: Sébastien GRAZIDE, Président: Sabir MOUNTASSER, etc.).
