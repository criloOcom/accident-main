...
12. **SESSIONS JULES — PARAMÈTRES OBLIGATOIRES** : Tout appel à `jules_create_session` DOIT inclure les trois paramètres suivants, sous peine de créer une session "repoless" (sans lien au dépôt) : `repo: "criloOcom/accident-main"`, `branch: "jules/M[Numéro]-[Thématique]"`, `autoPr: true`. Lire [🧠 Memory/JULES_MCP_GUIDELINES.md](%F0%9F%A7%A0%20Memory/JULES_MCP_GUIDELINES.md) avant tout appel. Voir aussi #12.b pour la clôture.
